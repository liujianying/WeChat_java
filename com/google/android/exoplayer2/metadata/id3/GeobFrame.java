...
public final class GeobFrame extends Id3Frame {
    ...
    public final boolean equals(Object obj) {
        ...
        if (t.i(this.mimeType, geobFrame.mimeType) && t.i(this.filename, geobFrame.filename) && t.i(this.description, geobFrame.description) && Arrays.equals(this.data, geobFrame.data)) {
            return true;
        }
        return false;
    }
