...
public final class t {
    ...
    public static ExecutorService aA(String str) {
    ...
    public static long aD(String str) {
        Matcher matcher = aCI.matcher(str);
        if (matcher.matches()) {
            int i;
    ...
    public static int l(byte[] bArr, int i, int i2) {
        for (int i3 = 0; i3 < i; i3++) {
            i2 = (i2 << 8) ^ aCL[((i2 >>> 24) ^ (bArr[i3] & 255)) & 255];
        }
        return i2;
    }
}
