...
class g$1 implements g {
    ...
    public final e k(Format format) {
        ...
        switch (obj) {
            ...
            case 5:
                return new com.google.android.exoplayer2.f.f.a(format.adY);
            case 6:
            case 7:
                return new com.google.android.exoplayer2.f.a.a(format.adW, format.aen);
            case 8:
                return new c(format.aen);
            case 9:
                return new com.google.android.exoplayer2.f.b.a(format.adY);
            default:
