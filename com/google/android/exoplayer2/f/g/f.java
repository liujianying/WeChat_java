...
final class f {
    ...
    L_0x0029:
        ...
        r7 = ao(r7);	 Catch:{ NumberFormatException -> 0x004d }
    ...
    L_0x0043:
        r0 = com.google.android.exoplayer2.f.g.h.aq(r0);	 Catch:{ NumberFormatException -> 0x004d }
    ...
    private static boolean a(String str, Matcher matcher, j jVar, a aVar, StringBuilder stringBuilder, List<d> list) {
        try {
            aVar.startTime = h.ap(matcher.group(1));
            aVar.endTime = h.ap(matcher.group(2));
