...
public final class a extends b {
    ...
    protected final d b(byte[] bArr, int i, boolean z) {
        CharSequence charSequence;
        this.azk.m(bArr, i);
        j jVar = this.azk;
        assertTrue(jVar.me() >= 2);
        ...
        if (readUnsignedShort == 0) {
            ...
            if (jVar.me() >= 2) {
                ...
                if (c == 65279 || c == 65534) {
                    charSequence2 = jVar.a(readUnsignedShort, Charset.forName("UTF-16"));
                }
            }
            charSequence2 = jVar.a(readUnsignedShort, Charset.forName("UTF-8"));
        }
        ...
        while (this.azk.me() >= 8) {
            ...
            this.azk.setPosition(i2 + readInt);
            f = f2;
        }
