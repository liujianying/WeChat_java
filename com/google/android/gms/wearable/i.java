...
public final class i {
    ...
    public final void a(String str, Asset asset) {
        this.bdo.put(str, asset);
    }

    public final Asset bC(String str) {
        Object obj = this.bdo.get(str);
        if (obj == null) {
            return null;
        }
        try {
    ...
    public final boolean equals(Object obj) {
        ...
        i iVar = (i) obj;
        if (this.bdo.size() != iVar.bdo.size()) {
            return false;
        }
        for (String str : this.bdo.keySet()) {
            Object obj2 = get(str);
            ...
            if (obj2 instanceof Asset) {
                ...
                boolean equals = (asset == null || asset2 == null) ? asset == asset2 : !TextUtils.isEmpty(asset.bdg) ? asset.bdg.equals(asset2.bdg) : Arrays.equals(asset.bdf, asset2.bdf);
                if (!equals) {
                    return false;
                }
    ...
    public final void putLong(String str, long j) {
        this.bdo.put(str, Long.valueOf(j));
    }
