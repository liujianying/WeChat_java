...
public final class ConnectionResult implements SafeParcelable {
    ...
    public final void b(Activity activity, int i) {
        if (op()) {
            activity.startIntentSenderForResult(this.aJD.getIntentSender(), i, null, 0, 0, 0);
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.aJC == connectionResult.aJC && v.c(this.aJD, connectionResult.aJD);
    }
    ...
    public final boolean op() {
        return (this.aJC == 0 || this.aJD == null) ? false : true;
    }
    ...
    public final String toString() {
        ...
        return ag.h(str, obj).h("resolution", this.aJD).toString();
    }
