...
public final class g implements Creator<WakeLockEvent> {
    static void a(WakeLockEvent wakeLockEvent, Parcel parcel) {
        ...
        b.a(parcel, 2, wakeLockEvent.aPo);
        b.a(parcel, 4, wakeLockEvent.aPz);
        b.c(parcel, 5, wakeLockEvent.aPA);
        b.a(parcel, 6, wakeLockEvent.aPB);
        b.a(parcel, 8, wakeLockEvent.aPw);
        b.a(parcel, 10, wakeLockEvent.aPE);
        b.c(parcel, 11, wakeLockEvent.aPp);
        b.a(parcel, 12, wakeLockEvent.aPC);
        b.a(parcel, 13, wakeLockEvent.aPF);
        b.c(parcel, 14, wakeLockEvent.aPD);
        float f = wakeLockEvent.aPG;
        b.b(parcel, 15, 4);
        parcel.writeFloat(f);
        b.u(parcel, t);
    }
