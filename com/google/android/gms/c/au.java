...
public final class au {
    ...
    private static a a(List<Asset> list, Object obj) {
        ...
        if (obj instanceof String) {
            aVar.type = 2;
            aVar.aZz.aZB = (String) obj;
        } else if (obj instanceof Integer) {
            aVar.type = 6;
            aVar.aZz.aZF = ((Integer) obj).intValue();
        } else if (obj instanceof Long) {
            aVar.type = 5;
            aVar.aZz.aZE = ((Long) obj).longValue();
        } else if (obj instanceof Double) {
            aVar.type = 3;
            aVar.aZz.aZC = ((Double) obj).doubleValue();
        } else if (obj instanceof Float) {
            aVar.type = 4;
            aVar.aZz.aZD = ((Float) obj).floatValue();
        } else if (obj instanceof Boolean) {
            aVar.type = 8;
            aVar.aZz.aZH = ((Boolean) obj).booleanValue();
        } else if (obj instanceof Byte) {
            aVar.type = 7;
            aVar.aZz.aZG = ((Byte) obj).byteValue();
        } else if (obj instanceof byte[]) {
            aVar.type = 1;
            aVar.aZz.aZA = (byte[]) obj;
        } else if (obj instanceof String[]) {
            aVar.type = 11;
            aVar.aZz.aZK = (String[]) obj;
        } else if (obj instanceof long[]) {
            aVar.type = 12;
            aVar.aZz.aZL = (long[]) obj;
        } else if (obj instanceof float[]) {
            aVar.type = 15;
            aVar.aZz.aZM = (float[]) obj;
        } else if (obj instanceof Asset) {
            aVar.type = 13;
            a.a aVar2 = aVar.aZz;
            list.add((Asset) obj);
            aVar2.aZN = (long) (list.size() - 1);
        } else if (obj instanceof i) {
            aVar.type = 9;
            i iVar = (i) obj;
            TreeSet treeSet = new TreeSet(iVar.bdo.keySet());
            ...
            while (true) {
                ...
                aVarArr[i2] = new av.a();
                aVarArr[i2].name = str;
                aVarArr[i2].aZx = a((List) list, iVar.get(str));
                i = i2 + 1;
            }
            aVar.aZz.aZI = aVarArr;
    ...
    public static i a(a aVar) {
        i iVar = new i();
        for (av.a aVar2 : aVar.aZt.aZv) {
            a(aVar.aZu, iVar, aVar2.name, aVar2.aZx);
        }
        return iVar;
    }

    private static ArrayList a(List<Asset> list, a.a aVar, int i) {
        ArrayList arrayList = new ArrayList(aVar.aZJ.length);
        for (a aVar2 : aVar.aZJ) {
            if (aVar2.type == 14) {
                arrayList.add(null);
            } else if (i == 9) {
                i iVar = new i();
                for (av.a aVar3 : aVar2.aZz.aZI) {
                    a(list, iVar, aVar3.name, aVar3.aZx);
                }
                arrayList.add(iVar);
            } else if (i == 2) {
                arrayList.add(aVar2.aZz.aZB);
            } else if (i == 6) {
                arrayList.add(Integer.valueOf(aVar2.aZz.aZF));
            } else {
    ...
    private static void a(List<Asset> list, i iVar, String str, a aVar) {
        ...
        a.a aVar2 = aVar.aZz;
        if (i == 1) {
            iVar.bdo.put(str, aVar2.aZA);
        } else if (i == 11) {
            iVar.bdo.put(str, aVar2.aZK);
        } else if (i == 12) {
            iVar.bdo.put(str, aVar2.aZL);
        } else if (i == 15) {
            iVar.bdo.put(str, aVar2.aZM);
        } else if (i == 2) {
            iVar.putString(str, aVar2.aZB);
        } else if (i == 3) {
            iVar.bdo.put(str, Double.valueOf(aVar2.aZC));
        } else if (i == 4) {
            iVar.bdo.put(str, Float.valueOf(aVar2.aZD));
        } else if (i == 5) {
            iVar.putLong(str, aVar2.aZE);
        } else if (i == 6) {
            iVar.bdo.put(str, Integer.valueOf(aVar2.aZF));
        } else if (i == 7) {
            iVar.bdo.put(str, Byte.valueOf((byte) aVar2.aZG));
        } else if (i == 8) {
            iVar.bdo.put(str, Boolean.valueOf(aVar2.aZH));
        } else if (i == 13) {
            if (list == null) {
                throw new RuntimeException("populateBundle: unexpected type for: " + str);
            }
            iVar.a(str, (Asset) list.get((int) aVar2.aZN));
        } else if (i == 9) {
            i iVar2 = new i();
            for (av.a aVar3 : aVar2.aZI) {
                a(list, iVar2, aVar3.name, aVar3.aZx);
            }
            iVar.bdo.put(str, iVar2);
        } else if (i == 10) {
            i = a(str, aVar2.aZJ);
    ...
    public static av.a[] a(i iVar, List<Asset> list) {
        ...
        while (true) {
            ...
            aVarArr[i2] = new av.a();
            aVarArr[i2].name = str;
            aVarArr[i2].aZx = a((List) list, obj);
            i = i2 + 1;
        }
    }
}
