...
public abstract class c$a extends Binder implements c {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        switch (i) {
            ...
            case 2:
                parcel.enforceInterface("com.google.android.auth.IAuthManagerService");
                c = b(parcel.readString(), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                parcel2.writeNoException();
                if (c != null) {
                    parcel2.writeInt(1);
                    c.writeToParcel(parcel2, 1);
            ...
            case 6:
                parcel.enforceInterface("com.google.android.auth.IAuthManagerService");
                c = h(parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                parcel2.writeNoException();
                if (c != null) {
                    parcel2.writeInt(1);
                    c.writeToParcel(parcel2, 1);
