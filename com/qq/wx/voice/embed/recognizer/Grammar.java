...
public class Grammar {
    ...
    private String a() {
        ...
        for (int i2 = 0; i2 < this.e.size(); i2++) {
            ((d) this.e.get(i2)).bgp = a(((d) this.e.get(i2)).userName);
            ((d) this.e.get(i2)).bgq = a(((d) this.e.get(i2)).bgn);
            ((d) this.e.get(i2)).bgr = a(((d) this.e.get(i2)).bgo);
        }
        StringBuffer stringBuffer = new StringBuffer("");
        while (i < this.e.size()) {
            String str = ((d) this.e.get(i)).bgp;
            if (!str.isEmpty()) {
    ...
    private static String a(String str) {
        return new String(str).replaceAll("[^(a-zA-Z0-9\\u4e00-\\u9fa5)]", "").replaceAll("0", "零").replaceAll("1", "一").replaceAll("2", "二").replaceAll("3", "三").replaceAll("4", "四").replaceAll("5", "五").replaceAll("6", "六").replaceAll("7", "七").replaceAll("8", "八").replaceAll("9", "九");
    }
    ...
    public int getResult(a aVar) {
        ...
        int i = 0;
        while (i < this.e.size()) {
            if (((d) this.e.get(i)).bgp.compareTo(this.b.name) == 0) {
                aVar.name = ((d) this.e.get(i)).userName;
                return 0;
            } else if (((d) this.e.get(i)).bgq.compareTo(this.b.name) == 0) {
                aVar.name = ((d) this.e.get(i)).userName;
                return 0;
