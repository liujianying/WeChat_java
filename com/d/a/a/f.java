...
public final class f {
    ...
    public final String q(byte[] bArr) {
        ...
        hashMap.put("app_name", bI(this.versionName));
        if (this.bgU != null) {
            hashMap.put("app_label", bI(Base64.encodeToString(this.bgU.getBytes(), 0)));
        } else {
        ...
        try {
            ...
            hashMap2.put("model", bI(Base64.encodeToString(this.bgV.getBytes(), 0)));
            hashMap2.put("version", bI(this.bgW));
            hashMap2.put("imei", bI(this.imei));
    ...
    private boolean sw() {
        boolean z = false;
        try {
            return this.bgQ.isProviderEnabled("gps");
        } catch (Exception e) {
            return z;
        }
    }
    ...
    private boolean sx() {
        ...
        boolean isWifiEnabled = this.bgP.isWifiEnabled();
        if (isWifiEnabled) {
            return isWifiEnabled;
        }
        try {
            if (VERSION.SDK_INT >= 18) {
                return this.bgP.isScanAlwaysAvailable();
            }
            return isWifiEnabled;
        } catch (Exception e) {
            return isWifiEnabled;
