...
final class r extends d {
            ...
            synchronized (rVar.bjJ) {
                ...
                if (stringBuilder.length() > 0) {
                    try {
                        ...
                        sF = new StringBuilder(String.valueOf("ST=" + String.valueOf(ai) + ',' + i2 + ',' + str2 + ',' + str3 + ',' + (z2 ? '1' : '0') + ',' + i3 + ',' + i4 + ',' + i)).append(stringBuilder).toString();
                        if (y.bmK) {
                            o.q("data_transaction_log_" + y.bmR, sF);
                        }
                        Object encode = Base64.encode(g.r(sF.getBytes("UTF-8")), 0);
                        ...
                        stringBuilder = new String(rVar.bjL.httpRequest(rVar.bjI.q(obj).getBytes("UTF-8")));
                        if (y.bmK) {
                            o.q("data_transaction_log_" + y.bmR, stringBuilder);
                        }
                        f e = e(stringBuilder, j, j2);
                        if (e.bjY) {
                            rVar.sG();
                            rVar.mRetryCount = 0;
                        } else {
    ...
    private static f e(String str, long j, long j2) {
        try {
            ...
            if (y.bmK) {
                o.q("data_transaction_log_" + y.bmR, str2);
            }
            ...
            if (y.bmK) {
                o.q("data_transaction_log_" + y.bmR, "parse json data error");
            }
    ...
    private void g(String str, long j) {
        ...
        if (!(str == null || str.startsWith("&OD[]="))) {
            String bN = v.bN(v.bO(str));
            bN = bN == null ? null : bN.replace("&MD=", "|MD,");
            if (bN != null) {
                str2 = bN.replace("&WD[]=", "|WD,");
            }
            str = v.a(str2, j, str3);
        }
        bK(str);
