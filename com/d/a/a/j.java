...
final class j {
            ...
            if (this.bhz.bip) {
                ...
                if (a(this.bhz.bil, dArr)) {
                    ...
                    while (true) {
                        ...
                        dArr9[obj2] = 0.0d;
                        for (i2 = 0; i2 < 4; i2++) {
                            dArr9[obj2] = dArr9[obj2] + (dArr[obj2][i2] * this.bhz.bik[i2]);
                        }
                        i2 = obj2 + 1;
                    }
                    dArr2 = dArr[0];
                    ...
                    if (a(dArr, this.bhz.bil)) {
                        ...
                        while (true) {
                            ...
                            this.bhz.bik[i2] = 0.0d;
                            for (i3 = 0; i3 < 4; i3++) {
                                dArr5 = this.bhz.bik;
                                dArr5[i2] = dArr5[i2] + (this.bhz.bil[i2][i3] * dArr9[i3]);
                            }
                            i3 = i2 + 1;
                        }
                    }
    ...
    private void b(double d, boolean z) {
        ...
        if (this.bhz.bip) {
            ...
            this.bhz.bil[1][1] = (this.bhz.bil[1][1] + ((this.bhz.bil[1][3] + this.bhz.bil[3][1]) * d4)) + (d5 * this.bhz.bil[3][3]);
            ...
            this.bhz.bil[3][1] = this.bhz.bil[3][1] + (d4 * this.bhz.bil[3][3]);
        }
        this.bhz.bhB = d;
    }
    ...
    private void c(double d, boolean z) {
        ...
        if (this.bhA.bip) {
            ...
            this.bhA.bil[1][1] = (this.bhA.bil[1][1] + ((this.bhA.bil[1][3] + this.bhA.bil[3][1]) * d4)) + (d5 * this.bhA.bil[3][3]);
            ...
            this.bhA.bil[3][1] = this.bhA.bil[3][1] + (d4 * this.bhA.bil[3][3]);
        }
        this.bhA.bhB = d;
    }
    ...
    final void a(int i, double[] dArr, double[] dArr2) {
        switch (i) {
            case 0:
