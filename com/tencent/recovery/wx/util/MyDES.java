...
public class MyDES {
    private static void a(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            byte[] bArr = myByteArray.bwd;
            int i3 = myByteArray.bwe + i2;
            bArr[i3] = (byte) (bArr[i3] ^ myByteArray2.bwd[myByteArray2.bwe + i2]);
        }
    }

    private static void b(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray.bwd[myByteArray.bwe + i2] = (byte) ((myByteArray2.bwd[(i2 >> 3) + myByteArray2.bwe] >> (i2 & 7)) & 1);
        }
    }
    ...
    private static void c(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        ...
        for (int i3 = 0; i3 < 28 - i; i3++) {
            myByteArray.bwd[myByteArray.bwe + i3] = myByteArray.bwd[(myByteArray.bwe + i3) + i];
        }
        while (i2 < i) {
            myByteArray.bwd[((myByteArray.bwe + i2) + 28) - i] = myByteArray2.bwd[myByteArray2.bwe + i2];
            i2++;
        }
    }
    ...
    private static void a(MyByteArray myByteArray, MyByteArray myByteArray2, byte[] bArr, int i, MyByteArray myByteArray3) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray3.bwd[myByteArray3.bwe + i2] = myByteArray2.bwd[(myByteArray2.bwe + bArr[i2]) - 1];
        }
    ...
    private static void a(MyByteArray myByteArray, MyByteArray myByteArray2, MyByteArray[] myByteArrayArr, MyByteArray myByteArray3, MyByteArray myByteArray4, MyByteArray myByteArray5, MyByteArray myByteArray6, MyByteArray myByteArray7, MyByteArray myByteArray8) {
        ...
        for (i = 0; i < 16; i++) {
            ...
            byte[] bArr3 = new byte[]{(byte) 16, (byte) 7, (byte) 20, (byte) 21, (byte) 29, (byte) 12, (byte) 28, (byte) 17, (byte) 1, (byte) 15, (byte) 23, (byte) 26, (byte) 5, (byte) 18, (byte) 31, (byte) 10, (byte) 2, (byte) 8, (byte) 24, (byte) 14, (byte) 32, (byte) 27, (byte) 3, (byte) 9, (byte) 19, (byte) 13, (byte) 30, (byte) 6, (byte) 22, (byte) 11, (byte) 4, (byte) 25};
            ...
            int i2 = myByteArray4.bwe;
            int i3 = myByteArray7.bwe;
            int i4 = 0;
            while (i4 < 8) {
                byte b = (byte) ((((myByteArray4.bwd[myByteArray4.bwe + 1] << 3) + (myByteArray4.bwd[myByteArray4.bwe + 2] << 2)) + (myByteArray4.bwd[myByteArray4.bwe + 3] << 1)) + myByteArray4.bwd[myByteArray4.bwe + 4]);
                MyByteArray myByteArray10 = myByteArray7;
                b(myByteArray10, new MyByteArray(r6[i4][(byte) ((myByteArray4.bwd[myByteArray4.bwe + 0] << 1) + myByteArray4.bwd[myByteArray4.bwe + 5])][b]), 4);
                i4 = (byte) (i4 + 1);
                myByteArray4.bwe += 6;
                myByteArray7.bwe += 4;
            }
        ...
        a(myByteArray, 8);
        for (i = 0; i < 64; i++) {
            byte[] bArr4 = myByteArray.bwd;
            int i5 = myByteArray.bwe + (i >> 3);
            bArr4[i5] = (byte) (bArr4[i5] | (myByteArray3.bwd[myByteArray3.bwe + i] << (i & 7)));
        }
    }
    ...
    public static char a(byte[] bArr, byte[] bArr2, long j, int i, byte[] bArr3) {
        ...
        if (bArr3 != null && bArr3.length > 0) {
            ...
            if (j2 != 0) {
                int i3;
                myByteArray6.bwe = 0;
                myByteArray6.bwd = myByteArray5.bwd;
                myByteArray7.bwe = 28;
                myByteArray7.bwd = myByteArray5.bwd;
                myByteArray8.bwe = 0;
                myByteArray8.bwd = myByteArray10.bwd;
                myByteArray9.bwe = 32;
                myByteArray9.bwd = myByteArray10.bwd;
                a(myByteArray4, 24);
                ...
                while (j3 < j2) {
                    for (i2 = 0; i2 < 8; i2++) {
                        myByteArray14.bwd[myByteArray14.bwe + i2] = (byte) (myByteArray14.bwd[myByteArray14.bwe + i2] ^ myByteArray2.bwd[myByteArray2.bwe + i2]);
                    }
    ...
    private static void d(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray.bwd[myByteArray.bwe + i2] = myByteArray2.bwd[myByteArray2.bwe + i2];
        }
    }

    private static void a(MyByteArray myByteArray, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray.bwd[myByteArray.bwe + i2] = (byte) 0;
        }
    }
}
