...
public final class a {
    public static int a(InputStream inputStream, InputStream inputStream2, File file) {
        ...
        byte[] z = b.z(inputStream);
        byte[] z2 = b.z(inputStream2);
        int length = z.length;
        int length2 = z2.length;
        DataInputStream dataInputStream = new DataInputStream(new ByteArrayInputStream(z2, 0, length2));
        dataInputStream.skip(8);
        long readLong = dataInputStream.readLong();
        long readLong2 = dataInputStream.readLong();
        int readLong3 = (int) dataInputStream.readLong();
        dataInputStream.close();
        InputStream byteArrayInputStream = new ByteArrayInputStream(z2, 0, length2);
        ...
        byteArrayInputStream = new ByteArrayInputStream(z2, 0, length2);
