...
final class ActivityStubs {
    static final String vtS = ActivityStubs.class.getPackage().getName();
    static final String vtT = (vtS + "." + ActivityStubs.class.getSimpleName() + "$STDStub_%02X");
    static final String vtU = (vtS + "." + ActivityStubs.class.getSimpleName() + "$SGTStub_%02X");
    static final String vtV = (vtS + "." + ActivityStubs.class.getSimpleName() + "$SGTKStub_%02X");
    static final String vtW = (vtS + "." + ActivityStubs.class.getSimpleName() + "$SIStub_%02X");
