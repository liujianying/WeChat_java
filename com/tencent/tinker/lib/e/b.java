...
public final class b {
    public static boolean c(ApplicationLike applicationLike) {
        if (applicationLike != null && applicationLike.getApplication() != null) {
            return ShareTinkerInternals.Ik(applicationLike.getTinkerFlags());
        }
    ...
    public static boolean d(ApplicationLike applicationLike) {
        ...
        if (tinkerResultIntent != null && ShareIntentUtil.aE(tinkerResultIntent) == 0) {
            return true;
        }
        return false;
    }
    ...
    public static String e(ApplicationLike applicationLike) {
        ...
        boolean ic = ShareTinkerInternals.ic(applicationLike.getApplication());
        if (j == null || j2 == null) {
            return null;
        }
        if (ic) {
    ...
    public static void f(ApplicationLike applicationLike) {
        ...
        SharePatchFileUtil.k(SharePatchFileUtil.hV(applicationLike.getApplication()));
    }
}
