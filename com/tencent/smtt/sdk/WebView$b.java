...
class WebView$b extends WebView {
    final /* synthetic */ WebView a;

    public WebView$b(WebView webView, Context context) {
        this(webView, context, null);
    }

    public WebView$b(WebView webView, Context context, AttributeSet attributeSet) {
        this.a = webView;
