...
public class WebSettings {
    ...
    public static String getDefaultUserAgent(Context context) {
        if (bv.a().b()) {
            return bv.a().c().i(context);
        }
        if (VERSION.SDK_INT < 17) {
            return null;
        }
        Object a = q.a(android.webkit.WebSettings.class, "getDefaultUserAgent", new Class[]{Context.class}, context);
    ...
    public boolean enableSmoothTransition() {
        ...
        Object a = q.a(this.b, "enableSmoothTransition");
    ...
    public boolean getAllowContentAccess() {
        ...
        Object a = q.a(this.b, "getAllowContentAccess");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public boolean getDisplayZoomControls() {
        ...
        Object a = q.a(this.b, "getDisplayZoomControls");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public boolean getMediaPlaybackRequiresUserGesture() {
        ...
        Object a = q.a(this.b, "getMediaPlaybackRequiresUserGesture");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public synchronized int getMixedContentMode() {
        ...
        if (this.c && this.a != null) {
            ...
            Object a = q.a(this.b, "getMixedContentMode", new Class[0], new Object[0]);
    ...
    public boolean getNavDump() {
        ...
        Object a = q.a(this.b, "getNavDump");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public synchronized PluginState getPluginState() {
        ...
        if (this.c && this.a != null) {
            ...
            Object a = q.a(this.b, "getPluginState");
            valueOf = a == null ? null : PluginState.valueOf(((PluginState) a).name());
        } else {
            valueOf = null;
        }
        return valueOf;
    ...
    public synchronized boolean getPluginsEnabled() {
        ...
        if (this.c && this.a != null) {
            ...
            Object a = q.a(this.b, "getPluginsEnabled");
            pluginsEnabled = a == null ? false : ((Boolean) a).booleanValue();
        } else if (VERSION.SDK_INT == 18) {
            pluginsEnabled = PluginState.ON == this.b.getPluginState();
        } else {
            pluginsEnabled = false;
        }
    ...
    public synchronized String getPluginsPath() {
        ...
        if (this.c && this.a != null) {
            ...
            Object a = q.a(this.b, "getPluginsPath");
    ...
    public synchronized int getTextZoom() {
        ...
        if (this.c && this.a != null) {
            ...
            try {
                ...
                Object a = q.a(this.b, "getTextZoom");
                textZoom = a == null ? 0 : ((Integer) a).intValue();
            }
        }
        return textZoom;
    }
    ...
    public boolean getUseWebViewBackgroundForOverscrollBackground() {
        ...
        Object a = q.a(this.b, "getUseWebViewBackgroundForOverscrollBackground");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public void setAllowContentAccess(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setAllowContentAccess", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setAllowFileAccessFromFileURLs(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setAllowFileAccessFromFileURLs", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setAllowUniversalAccessFromFileURLs(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setAllowUniversalAccessFromFileURLs", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setDatabasePath(String str) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setDatabasePath", new Class[]{String.class}, str);
        }
    }
    ...
    public void setDisplayZoomControls(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setDisplayZoomControls", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setEnableSmoothTransition(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setEnableSmoothTransition", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setLayoutAlgorithm(LayoutAlgorithm layoutAlgorithm) {
        if (this.c && this.a != null) {
            this.a.setLayoutAlgorithm(LayoutAlgorithm.valueOf(layoutAlgorithm.name()));
        } else if (!this.c && this.b != null) {
    ...
    public void setMediaPlaybackRequiresUserGesture(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setMediaPlaybackRequiresUserGesture", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setMixedContentMode(int i) {
        if ((!this.c || this.a == null) && !this.c && this.b != null && VERSION.SDK_INT >= 21) {
            q.a(this.b, "setMixedContentMode", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }
    ...
    public void setNavDump(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setNavDump", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public synchronized void setPluginState(PluginState pluginState) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setPluginState", new Class[]{PluginState.class}, valueOf);
        }
    }
    ...
    public void setPluginsEnabled(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setPluginsEnabled", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public synchronized void setPluginsPath(String str) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setPluginsPath", new Class[]{String.class}, str);
        }
    }
    ...
    public synchronized void setTextZoom(int i) {
        if (this.c && this.a != null) {
            ...
            try {
                ...
                q.a(this.b, "setTextZoom", new Class[]{Integer.TYPE}, Integer.valueOf(i));
            }
        }
        return;
    }
    ...
    public void setUseWebViewBackgroundForOverscrollBackground(boolean z) {
        if (this.c && this.a != null) {
            ...
            q.a(this.b, "setUseWebViewBackgroundForOverscrollBackground", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
