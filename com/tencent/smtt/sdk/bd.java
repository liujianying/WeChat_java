...
class bd {
    ...
    public Object a(Context context, Object obj, Bundle bundle) {
        if (this.a != null) {
            this.b = this.a.newInstance("com.tencent.tbs.cache.TbsVideoCacheTaskProxy", new Class[]{Context.class, Object.class, Bundle.class}, new Object[]{context, obj, bundle});
        }
        return this.b;
    }
    ...
    public void a(boolean z) {
        if (this.a != null) {
            this.a.invokeMethod(this.b, "com.tencent.tbs.cache.TbsVideoCacheTaskProxy", "removeTask", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
