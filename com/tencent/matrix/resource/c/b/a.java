...
public final class a {
    ...
    public static Object a(InputStream inputStream, c cVar, int i) {
        switch (cVar) {
            ...
            case FLOAT:
                return Float.valueOf(Float.intBitsToFloat(d(inputStream)));
            case DOUBLE:
                return Double.valueOf(Double.longBitsToDouble(e(inputStream)));
            case BYTE:
                return Byte.valueOf((byte) inputStream.read());
            case SHORT:
                return Short.valueOf(c(inputStream));
            case INT:
                return Integer.valueOf(d(inputStream));
            case LONG:
                return Long.valueOf(e(inputStream));
            default:
                return null;
        }
    }
