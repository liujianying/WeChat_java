...
public final class ta extends View {
    ...
    public ta(sl slVar) {
        ...
        this.h.setStrokeWidth(6.0f * slVar.f().b());
        this.h.setStyle(Style.STROKE);
        this.i = new Paint();
        this.i.setAntiAlias(true);
        this.i.setColor(Color.rgb(100, 100, 100));
        this.i.setStrokeWidth(10.0f * slVar.f().b());
        this.i.setStyle(Style.STROKE);
        this.s = new Paint();
        this.s.setAntiAlias(true);
        this.s.setColor(Color.rgb(b.CTRL_BYTE, b.CTRL_BYTE, b.CTRL_BYTE));
        this.s.setStrokeWidth(7.0f * slVar.f().b());
        this.s.setStyle(Style.STROKE);
        this.g = new Paint();
        this.g.setAntiAlias(true);
        this.g.setColor(-16777216);
        this.g.setTextSize(25.0f * slVar.f().b());
        this.j = new Rect();
    }
