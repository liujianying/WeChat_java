...
final class d extends q {
    ...
    protected final boolean tL() {
        return s.o(this.context, "android.permission.WRITE_EXTERNAL_STORAGE") && Environment.getExternalStorageState().equals("mounted");
    }
    ...
    protected final String read() {
        ...
        synchronized (this) {
            try {
                for (String str2 : c.j(new File(Environment.getExternalStorageDirectory(), s.decode("6X8Y4XdM2Vhvn0KfzcEatGnWaNU=")))) {
    ...
    protected final void write(String str) {
        synchronized (this) {
            c.cf(Environment.getExternalStorageDirectory() + "/" + s.decode("6X8Y4XdM2Vhvn0I="));
            try {
