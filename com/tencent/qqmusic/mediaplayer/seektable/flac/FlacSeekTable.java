...
public class FlacSeekTable implements SeekTable {
    ...
    public void parse(InputStream inputStream) {
        ParsableInputStreamWrapper parsableInputStreamWrapper = new ParsableInputStreamWrapper(inputStream);
        if (seekToFlac(parsableInputStreamWrapper)) {
            if (!walkThrough(parsableInputStreamWrapper, this.sampleRate == 0 ? new BlockHandler[]{new SeektableHandler(), new StreamInfoHandler(this)} : new BlockHandler[]{new SeektableHandler()})) {
