...
class MP3Header {
    ...
    MP3Header() {
        r0 = new int[2][][];
        r0[0] = new int[][]{new int[]{0, 32, 64, 96, 128, JsApiSetBackgroundAudioState.CTRL_INDEX, 192, 224, 256, 288, 320, 352, 384, 416, 448}, new int[]{0, 32, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, 128, JsApiSetBackgroundAudioState.CTRL_INDEX, 192, 224, 256, 320, 384}, new int[]{0, 32, 40, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, 128, JsApiSetBackgroundAudioState.CTRL_INDEX, 192, 224, 256, 320}};
        r0[1] = new int[][]{new int[]{0, 32, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, 128, 144, JsApiSetBackgroundAudioState.CTRL_INDEX, 176, 192, 224, 256}, new int[]{0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, 128, 144, JsApiSetBackgroundAudioState.CTRL_INDEX}, new int[]{0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, 128, 144, JsApiSetBackgroundAudioState.CTRL_INDEX}};
        this.bitrate = r0;
    }
