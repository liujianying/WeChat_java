...
public class WaveReader {
    ...
    private static int readUnsignedIntLE(byte[] bArr, int i) {
        ...
        return (((bArr[0] & WebView.NORMAL_MODE_ALPHA) | ((bArr[i + 1] & WebView.NORMAL_MODE_ALPHA) << 8)) | ((bArr[i + 2] & WebView.NORMAL_MODE_ALPHA) << 16)) | ((bArr[i + 3] & WebView.NORMAL_MODE_ALPHA) << 24);
    }
    ...
    private static short byteToShortLE(byte b, byte b2) {
        return (short) ((b & WebView.NORMAL_MODE_ALPHA) | ((b2 & WebView.NORMAL_MODE_ALPHA) << 8));
    }
}
