...
class Reporters$1 implements Visitor {
    ...
    public final void visitSpeedCheck(List<SpeedCheck> list, PerformanceTracer$OverallInfo performanceTracer$OverallInfo) {
        File file = performanceTracer$OverallInfo.mediaFile;
        long round = Math.round(((double) performanceTracer$OverallInfo.totalPcmToBePlayed) / ((double) performanceTracer$OverallInfo.timeCostInMs));
        ...
        stringBuilder.append("\t总耗时 (ms): ").append(performanceTracer$OverallInfo.timeCostInMs).append("\n");
        stringBuilder.append("\t播放PCM数据量 (byte): ").append(performanceTracer$OverallInfo.totalPcmToBePlayed).append("\n");
        ...
        stringBuilder.append("\n");
        Reporters.access$000(list, stringBuilder, performanceTracer$OverallInfo.timeCostInMs);
