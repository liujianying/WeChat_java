        ...
        try {
                ...
                try {
                    ...
                    if (byteArrayOutputStream != null) {
                        try {
                            ...
                            x.printErrStackTrace(TAG, e5, "", new Object[0]);
                        }
                    }
                    if (dataOutputStream != null) {
                        try {
                            ...
                            x.printErrStackTrace(TAG, e52, "", new Object[0]);
                        }
                    }
                    return null;
                } catch (Throwable th) {
            ...
            if (byteArrayOutputStream != null) {
                try {
                    ...
                    x.printErrStackTrace(TAG, e522, "", new Object[0]);
                }
            }
            if (dataOutputStream != null) {
                try {
                    ...
                    x.printErrStackTrace(TAG, e5222, "", new Object[0]);
                }
            }
            return null;
        } catch (Throwable th3) {
