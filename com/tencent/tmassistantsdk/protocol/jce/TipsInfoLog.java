...
public final class TipsInfoLog extends JceStruct implements Cloneable {
    ...
    public final void readFrom(JceInputStream jceInputStream) {
        ...
        this.gameVersionCode = jceInputStream.read(this.gameVersionCode, 3, $assertionsDisabled);
        this.gameChannelId = jceInputStream.readString(4, $assertionsDisabled);
        this.authorizedTipsCount = jceInputStream.read(this.authorizedTipsCount, 5, $assertionsDisabled);
        this.downloadTipsCount = jceInputStream.read(this.downloadTipsCount, 6, $assertionsDisabled);
        this.installTipsCount = jceInputStream.read(this.installTipsCount, 7, $assertionsDisabled);
        this.networkErrorTipsCount = jceInputStream.read(this.networkErrorTipsCount, 8, $assertionsDisabled);
        this.cancelBtnClickCount = jceInputStream.read(this.cancelBtnClickCount, 9, $assertionsDisabled);
        this.downloadBtnClickCount = jceInputStream.read(this.downloadBtnClickCount, 10, $assertionsDisabled);
        this.installBtnClickCount = jceInputStream.read(this.installBtnClickCount, 11, $assertionsDisabled);
        this.authorizedBtnClickCount = jceInputStream.read(this.authorizedBtnClickCount, 12, $assertionsDisabled);
    }
    ...
    public final void displaySimple(StringBuilder stringBuilder, int i) {
        ...
        jceDisplayer.displaySimple(this.authorizedBtnClickCount, $assertionsDisabled);
    }
}
