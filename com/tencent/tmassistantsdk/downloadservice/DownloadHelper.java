...
public class DownloadHelper {
    ...
    public static String generateFileNameFromURL(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            if (str2.equals(Downloads.CONTENT_TYPE_APK)) {
                str3 = ".apk";
            } else if (str2.equals(Downloads.CONTENT_TYPE_APKDIFF)) {
                str3 = ".diff";
            } else if (str2.equals(Downloads.CONTENT_TYPE_OTHERS)) {
                str3 = ".other";
            }
        }
                ...
                try {
                    if (context.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") != 0) {
                        ...
                        if (activeNetworkInfo == null) {
                            ...
                            str = TencentExtraKeys.LOCATION_SOURCE_WIFI;
                        } else {
