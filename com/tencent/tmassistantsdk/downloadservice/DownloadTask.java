...
public class DownloadTask {
        ...
        while (z2) {
            ...
            try {
                ...
                if (this.mStopTask) {
                    ...
                    TMLog.i(TAG, "StopRequestException, errCode = " + e3.mFinalErrCode + " " + Thread.currentThread().getName());
                    x.printErrStackTrace(TAG, e3, "", new Object[0]);
                    this.mDownloadInfo.mDownloadFailedErrCode = e3.mFinalErrCode;
                    if (e3.mFinalErrCode == 703 || e3.mFinalErrCode == 710 || e3.mFinalErrCode == 711) {
                        z3 = z;
                        z2 = false;
                    } else if (704 == e3.mFinalErrCode) {
    ...
    L_0x02f1:
        ...
        com.tencent.mm.sdk.platformtools.x.printErrStackTrace(r1, r0, r4, r5);	 Catch:{ all -> 0x0305 }
