...
public abstract class ITMAssistantDownloadSDKServiceInterface$Stub extends Binder implements ITMAssistantDownloadSDKServiceInterface {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        switch (i) {
            ...
            case 10:
                parcel.enforceInterface(DESCRIPTOR);
                registerDownloadTaskCallback(parcel.readString(), Stub.asInterface(parcel.readStrongBinder()));
                parcel2.writeNoException();
                return true;
            case 11:
                parcel.enforceInterface(DESCRIPTOR);
                unregisterDownloadTaskCallback(parcel.readString(), Stub.asInterface(parcel.readStrongBinder()));
                parcel2.writeNoException();
                return true;
            case 1598968902:
