        ...
        if (z || i3 > 0) {
            ...
            switch (i) {
                case 0:
                    ...
                    AssetFileDescriptor openRawResourceFd2 = this._context.getResources().openRawResourceFd(i2);
                    if (openRawResourceFd2 != null) {
                        this.mMediaPlay.setDataSource(openRawResourceFd2.getFileDescriptor(), openRawResourceFd2.getStartOffset(), openRawResourceFd2.getLength());
