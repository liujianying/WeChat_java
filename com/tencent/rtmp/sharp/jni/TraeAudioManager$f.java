...
class TraeAudioManager$f extends Thread {
    ...
    int b(HashMap<String, Object> hashMap) {
        ...
        intent.putExtra("EXTRA_DATA_IF_HAS_BLUETOOTH_THIS_IS_NAME", this.p._deviceConfigManager.d());
    ...
    int c(HashMap<String, Object> hashMap) {
        ...
        if (this.p._am == null) {
            ...
            num = (Integer) hashMap.get("PARAM_STREAMTYPE");
            if (num == null) {
                if (QLog.isColorLevel()) {
            ...
            } else if (this.p._deviceConfigManager.h().equals("DEVICE_SPEAKERPHONE")) {
                this.p.InternalSetMode(0);
                a(3);
            } else {
    ...
    int e(HashMap<String, Object> hashMap) {
        ...
        try {
            this.c = ((Long) hashMap.get("PARAM_SESSIONID")).longValue();
    ...
    int g(HashMap<String, Object> hashMap) {
        ...
        Intent intent = new Intent();
        intent.putExtra("EXTRA_DATA_STREAMTYPE", streamType);
        this.p.sendResBroadcast(intent, hashMap, 0);
        AudioDeviceInterface.LogTraceExit();
        return 0;
    }
    ...
    int i() {
        ...
        if (this.p._am == null) {
            ...
            this.p._activeMode = 0;
            HashMap hashMap = new HashMap();
            hashMap.put("PARAM_SESSIONID", Long.valueOf(this.c));
