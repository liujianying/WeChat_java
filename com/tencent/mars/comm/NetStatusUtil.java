...
public class NetStatusUtil {
    ...
    public static int getNetTypeForStat(Context context) {
        ...
        try {
            ...
            return subtype * TbsLog.TBSLOG_CODE_SDK_BASE;
        } catch (Exception e) {
            return 999;
        }
    }
    ...
    public static int getStrength(Context context) {
        ...
        try {
            if (getNetTypeForStat(context) == 1) {
                return Math.abs(((WifiManager) context.getSystemService(TencentExtraKeys.LOCATION_SOURCE_WIFI)).getConnectionInfo().getRssi());
            }
