...
public class PlatformComm {
    ...
    private static ag handler = null;
    ...
    public static class C2Java {
        ...
        public static int getNetInfo() {
            ...
            try {
                ...
                try {
                    ...
                    x.printErrStackTrace(PlatformComm.TAG, e, "", new Object[0]);
                    return 3;
                }
            } catch (Exception e2) {
        ...
        public static int getStatisticsNetType() {
            ...
            try {
                int netType = ao.getNetType(PlatformComm.context);
                if (netType == -1) {
                    return -1;
                }
                if (ao.is2G(PlatformComm.context)) {
                    return 3;
                }
                if (ao.is3G(PlatformComm.context)) {
                    return 4;
                }
                if (ao.is4G(PlatformComm.context)) {
                    return 5;
                }
                ...
                x.e(PlatformComm.TAG, exception2String(e));
                x.printErrStackTrace(PlatformComm.TAG, e, "", new Object[0]);
        ...
        public static boolean startAlarm(int i, int i2) {
            ...
            try {
                ...
                x.e(PlatformComm.TAG, exception2String(e));
                x.printErrStackTrace(PlatformComm.TAG, e, "", new Object[z]);
        ...
        public static WifiInfo getCurWifiInfo() {
            try {
                ...
                try {
                    ...
                    x.e(PlatformComm.TAG, "getActiveNetworkInfo failed.");
                    activeNetworkInfo = null;
                }
                if (activeNetworkInfo != null) {
                ...
                x.printErrStackTrace(PlatformComm.TAG, e2, "", new Object[0]);
                return null;
            }
        }
        ...
        public static SIMInfo getCurSIMInfo() {
            try {
                ...
                int iSPCode = ao.getISPCode(PlatformComm.context);
                if (iSPCode == 0) {
                    return null;
                }
                SIMInfo sIMInfo = new SIMInfo();
                sIMInfo.ispCode = String.valueOf(iSPCode);
                x.d(PlatformComm.TAG, "getISPCode MCC_MNC=%s", sIMInfo.ispCode);
                sIMInfo.ispName = ao.getISPName(PlatformComm.context);
                return sIMInfo;
            } catch (Throwable e) {
                x.printErrStackTrace(PlatformComm.TAG, e, "", new Object[0]);
                return null;
        ...
        public static boolean isNetworkConnected() {
            ...
            try {
                return ao.isNetworkConnected(PlatformComm.context);
            } catch (Throwable e) {
                x.e(PlatformComm.TAG, exception2String(e));
                x.printErrStackTrace(PlatformComm.TAG, e, "", new Object[z]);
                Assert.assertTrue(e.getClass().getSimpleName() + ":" + e.getStackTrace()[z] + ", " + e.getStackTrace()[1], z);
