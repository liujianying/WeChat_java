...
public class MMLogic {
    ...
    private static String getUserIDCLocale() {
        try {
            return bi.fU(ad.getContext()) ? "HK" : "CN";
        } catch (Exception e) {
            return null;
        }
    }
    ...
    private static void reportFlow(int i, int i2, int i3, int i4) {
        ...
        b bVar = aa.UV().etx;
        x.i("C2Java", "reportNetFlow time[%d,%d] sum:%d wr[%d,%d] ws[%d,%d] mr[%d,%d] ms[%d,%d] fgbg:%b Moniter:%s", new Object[]{Long.valueOf(lastReportTime), Long.valueOf(bi.bG(lastReportTime)), Integer.valueOf(i5), Integer.valueOf(i), Integer.valueOf(totalWifiRecv), Integer.valueOf(i2), Integer.valueOf(totalWifiSend), Integer.valueOf(i3), Integer.valueOf(totalMobileRecv), Integer.valueOf(i4), Integer.valueOf(totalMobileSend), Boolean.valueOf(com.tencent.mm.sdk.a.b.foreground), bVar});
        if (bVar != null) {
            if (i5 >= 102400 || bi.bG(lastReportTime) >= 30) {
                lastReportTime = bi.VE();
                ...
                totalMobileSend = 0;
                try {
                    aa.UX().post(new 2(bVar, i6, i7, i8, i9));
                } catch (Throwable th) {
                    x.e("C2Java", "reportFlowData :%s", new Object[]{bi.i(th)});
                }
            }
        }
    }
    ...
    private static void onOOBNotify(String str) {
        ...
        try {
            aa.UX().post(new 3(str));
        } catch (Throwable e) {
            x.e("C2Java", "onOOBNotify :%s", new Object[]{bi.i(e)});
        }
    }
}
