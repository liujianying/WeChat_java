...
public final class SQLiteConnectionPool implements Closeable {
            ...
            if (sQLiteConnection != null) {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        LockSupport.parkNanos(1000000 * j2);
                        Thread.interrupted();
                        synchronized (this.mLock) {
                            throwIfClosedLocked();
                            ...
                            if (sQLiteConnection == null && runtimeException == null) {
                                ...
                                if (uptimeMillis < j) {
                                    ...
                                    logConnectionPoolBusyLocked(str, uptimeMillis - obtainConnectionWaiterLocked.mStartTime, i);
                                    uptimeMillis += CONNECTION_POOL_BUSY_MILLIS;
    ...
    private void logConnectionPoolBusyLocked(String str, long j, int i) {
        ...
        if (!this.mAcquiredConnections.isEmpty()) {
            ...
            while (true) {
                ...
                String describeCurrentOperationUnsafe = ((SQLiteConnection) it.next()).describeCurrentOperationUnsafe();
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (it2.hasNext()) {
                stringBuilder.append("  ").append((String) it2.next()).append("\n");
            }
        }
    ...
    final void setCheckpointListener(SQLiteCheckpointListener sQLiteCheckpointListener) {
        SQLiteDatabase sQLiteDatabase = (SQLiteDatabase) this.mDB.get();
    ...
    final void notifyCheckpoint(String str, int i) {
        SQLiteDatabase sQLiteDatabase = (SQLiteDatabase) this.mDB.get();
