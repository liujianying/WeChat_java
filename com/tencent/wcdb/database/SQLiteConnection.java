...
public final class SQLiteConnection implements OnCancelListener {
    ...
    private final class OperationLog {
        ...
        private Operation getOperationLocked(int i) {
            Operation operation = this.mOperations[i & COOKIE_INDEX_MASK];
            ...
            synchronized (this.mOperations) {
                ...
                if (operation != null) {
                    ...
                    while (true) {
                        int i3 = i2;
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("    ").append(i3).append(": [");
            ...
            while (true) {
                ...
                if (it.hasNext()) {
                    ...
                    if (preparedStatement.mInCache) {
                        printer.println("    " + i2 + ": statementPtr=0x" + Long.toHexString(preparedStatement.getPtr()) + ", numParameters=" + preparedStatement.mNumParameters + ", type=" + preparedStatement.mType + ", readOnly=" + preparedStatement.mReadOnly + ", sql=\"" + SQLiteConnection.trimSqlForDisplay((String) entry.getKey()) + "\"");
                    }
                    i = i2 + 1;
                } else {
                    return;
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (this.mRecentOperations.endOperationDeferLog(i6)) {
                                    this.mRecentOperations.logOperation(i6, "window='" + cursorWindow + "', startPos=" + i + ", actualPos=" + i7 + ", filledRows=" + numRows + ", countedRows=" + i8);
                                }
                                ...
                                try {
                                    ...
                                    th = th5;
                                    if (this.mRecentOperations.endOperationDeferLog(i6)) {
                                        this.mRecentOperations.logOperation(i6, "window='" + cursorWindow + "', startPos=" + i + ", actualPos=" + i3 + ", filledRows=" + i5 + ", countedRows=" + i4);
                                    }
                                    throw th;
                                }
                            } catch (Throwable th6) {
    ...
    final void collectDbStats(java.util.ArrayList<com.tencent.wcdb.database.SQLiteDebug.DbStats> r15) {
        /*
        r14 = this;
        r0 = r14.mConnectionPtr;
        r1 = nativeGetDbLookaside(r0);
        r2 = 0;
        r4 = 0;
        r0 = "PRAGMA page_count;";
        r6 = 0;
        r7 = 0;
        r2 = r14.executeForLong(r0, r6, r7);	 Catch:{ SQLiteException -> 0x00d9 }
        r0 = "PRAGMA page_size;";
        r6 = 0;
        r7 = 0;
        r4 = r14.executeForLong(r0, r6, r7);	 Catch:{ SQLiteException -> 0x00d9 }
    L_0x001c:
        r0 = r14;
        r0 = r0.getMainDbStatsUnsafe(r1, r2, r4);
        r15.add(r0);
        r3 = new com.tencent.wcdb.CursorWindow;
        r0 = "collectDbStats";
        r3.<init>(r0);
        r1 = "PRAGMA database_list;";
        r2 = 0;
        r4 = 0;
        r5 = 0;
        r6 = 0;
        r7 = 0;
        r0 = r14;
        r0.executeForCursorWindow(r1, r2, r3, r4, r5, r6, r7);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = 1;
        r2 = r0;
    L_0x003a:
        r0 = r3.getNumRows();	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        if (r2 >= r0) goto L_0x00cb;
    L_0x0040:
        r0 = 1;
        r4 = r3.getString(r2, r0);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = 2;
        r10 = r3.getString(r2, r0);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = 0;
        r8 = 0;
        r5 = new java.lang.StringBuilder;	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r6 = "PRAGMA ";
        r5.<init>(r6);	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r5 = r5.append(r4);	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r6 = ".page_count;";
        r5 = r5.append(r6);	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r5 = r5.toString();	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r6 = 0;
        r7 = 0;
        r0 = r14.executeForLong(r5, r6, r7);	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r5 = new java.lang.StringBuilder;	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r6 = "PRAGMA ";
        r5.<init>(r6);	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r5 = r5.append(r4);	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        ...
        r6 = 0;
        r7 = 0;
        r8 = r14.executeForLong(r5, r6, r7);	 Catch:{ SQLiteException -> 0x00c8, all -> 0x00d4 }
        r6 = r0;
    L_0x0089:
        r0 = new java.lang.StringBuilder;	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r1 = "  (attached) ";
        r0.<init>(r1);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = r0.append(r4);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r5 = r0.toString();	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = r10.length();	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        if (r0 == 0) goto L_0x00b7;
    L_0x009f:
        r0 = new java.lang.StringBuilder;	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0.<init>();	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = r0.append(r5);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r1 = ": ";
        r0 = r0.append(r1);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = r0.append(r10);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r5 = r0.toString();	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
    L_0x00b7:
        r4 = new com.tencent.wcdb.database.SQLiteDebug$DbStats;	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r10 = 0;
        r11 = 0;
        r12 = 0;
        r13 = 0;
        r4.<init>(r5, r6, r8, r10, r11, r12, r13);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r15.add(r4);	 Catch:{ SQLiteException -> 0x00cf, all -> 0x00d4 }
        r0 = r2 + 1;
        r2 = r0;
        goto L_0x003a;
    L_0x00c8:
