...
public class NotifyFreqLimit extends BroadcastReceiver {
    ...
    private static m dZZ = null;
    private static byte[] dsN = new byte[0];
    private static int eaa = 0;
    private static long[] eab = null;
    private static LinkedList<Object> eac = new LinkedList();
    private static int ead = 0;
    private static Boolean eae = null;
    private static Boolean eaf = null;
    private static long eag = 0;
    private static PendingIntent eah = null;
    ...
    public void onReceive(android.content.Context r23, android.content.Intent r24) {
        /*
        r22 = this;
        r11 = dsN;	 Catch:{ Throwable -> 0x00fb }
    ...
    L_0x0021:
        ...
        com.tencent.mm.sdk.platformtools.x.e(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
    ...
    L_0x002d:
        ...
        r2 = com.tencent.mm.sdk.platformtools.bi.VF();	 Catch:{ all -> 0x00f8 }
        r14 = r2 - r12;
        r2 = "pid";
        r3 = 0;
        r0 = r24;
        ...
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        r6 = 6;
        r7 = eah;	 Catch:{ all -> 0x00f8 }
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        r6 = 7;
        r7 = dZY;	 Catch:{ all -> 0x00f8 }
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.x.i(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
        r3 = eah;	 Catch:{ all -> 0x00f8 }
        if (r3 != 0) goto L_0x0120;
    L_0x00a8:
        r3 = com.tencent.mm.plugin.report.service.h.mEJ;	 Catch:{ all -> 0x00f8 }
        r4 = 99;
        ...
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        r2 = 6;
        r6 = eah;	 Catch:{ all -> 0x00f8 }
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        r2 = 7;
        r6 = dZY;	 Catch:{ all -> 0x00f8 }
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.x.e(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
        monitor-exit(r11);	 Catch:{ all -> 0x00f8 }
        goto L_0x0027;
    ...
    L_0x0188:
        ...
        eaf = r3;	 Catch:{ all -> 0x00f8 }
        r3 = com.tencent.mm.sdk.platformtools.ad.getContext();	 Catch:{ all -> 0x00f8 }
        ...
        r4 = com.tencent.mm.sdk.platformtools.bi.oV(r4);	 Catch:{ all -> 0x00f8 }
        ...
        r8 = com.tencent.mm.sdk.platformtools.bi.VF();	 Catch:{ all -> 0x00f8 }
        ...
        r3 = com.tencent.mm.sdk.platformtools.bi.oW(r4);	 Catch:{ all -> 0x00f8 }
    ...
    L_0x022c:
        ...
        r6 = new java.lang.Object[r6];	 Catch:{ all -> 0x00f8 }
        r7 = 0;
        r8 = eaf;	 Catch:{ all -> 0x00f8 }
        r6[r7] = r8;	 Catch:{ all -> 0x00f8 }
        r7 = 1;
        r6[r7] = r4;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.x.i(r3, r5, r6);	 Catch:{ all -> 0x00f8 }
    L_0x0240:
        r3 = dZY;	 Catch:{ all -> 0x00f8 }
