...
public abstract class f implements d {
    ...
    private void checkIfNeedDefaultDependency() {
        a aVar = (a) h.Eo().Ee().dqd.drY.get(getClass());
        int i = (aVar == null || !(aVar.Ez() || aVar.EB())) ? 0 : 1;
        if (i == 0) {
            Class cls = h.Eo().Ee().dqg;
            if (cls != null) {
                dependsOn(cls);
