...
public class WxViewPager extends ViewGroup {
    private static final f uuN = new f();
    ...
    private boolean wH;
    private int wI;
    private android.support.v4.view.ViewPager.e wK;
    private android.support.v4.view.ViewPager.e wL;
    private f wN;
    private Method wO;
    private int wP;
    ...
    class c extends a {
        ...
        public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            android.support.v4.view.a.f cw = android.support.v4.view.a.f.cw();
            cw.setScrollable(cm());
            if (accessibilityEvent.getEventType() == 4096 && WxViewPager.this.wa != null) {
                cw.setItemCount(WxViewPager.this.wa.getCount());
                cw.setFromIndex(WxViewPager.this.wb);
                cw.setToIndex(WxViewPager.this.wb);
            }
        }
        ...
        public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            switch (i) {
                case 4096:
                    ...
                    WxViewPager.this.setCurrentItem(WxViewPager.this.wb + 1);
                    return true;
                case 8192:
                    if (!WxViewPager.this.canScrollHorizontally(-1)) {
                        return false;
        ...
        private boolean cm() {
            return WxViewPager.this.wa != null && WxViewPager.this.wa.getCount() > 1;
        }
    }
    ...
    public void setAdapter(u uVar) {
        if (this.wa != null) {
            int i;
            this.wa.unregisterDataSetObserver(this.uuL);
        ...
        if (this.wa != null) {
            if (this.uuL == null) {
                this.uuL = new e(this, (byte) 0);
            }
            this.wa.registerDataSetObserver(this.uuL);
            this.wr = false;
            boolean z = this.wF;
            this.wF = true;
    ...
    private void a(int i, boolean z, int i2, boolean z2) {
        ...
        int i3 = 0;
        if (Gd != null) {
            i3 = (int) (((float) getClientWidth()) * Math.max(this.wm, Math.min(Gd.wW, this.wn)));
        }
        if (z) {
            if (getChildCount() == 0) {
                setScrollingCacheEnabled(false);
                ...
                if (i4 == 0 && i5 == 0) {
                    ...
                    this.wf.startScroll(scrollX, scrollY, i4, i5, Math.min(i3, 600));
                    z.E(this);
                }
            }
            if (z2 && this.wK != null) {
    ...
    L_0x00ba:
        r0 = r14.bA;
        r0 = r0.get(r3);
        r0 = (com.tencent.mm.ui.mogic.WxViewPager.b) r0;
        r5 = r0.position;
        r6 = r14.wb;
    ...
    L_0x0225:
        ...
        r0 = (com.tencent.mm.ui.mogic.WxViewPager.LayoutParams) r0;
        r0.wZ = r2;
        r5 = r0.wX;
    ...
    L_0x0293:
        ...
        goto L_0x00ce;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.ui.mogic.WxViewPager.al(int):void");
    }
    ...
    private void e(int i, int i2, int i3, int i4) {
        if (i2 <= 0 || this.bA.isEmpty()) {
            b Gd = Gd(this.wb);
            int min = (int) ((Gd != null ? Math.min(Gd.wW, this.wn) : 0.0f) * ((float) ((i - getPaddingLeft()) - getPaddingRight())));
            if (min != getScrollX()) {
                x(false);
        ...
        if (!this.wf.isFinished()) {
            int duration = this.wf.getDuration() - this.wf.timePassed();
            b Gd2 = Gd(this.wb);
            if (Gd2 != null) {
                this.wf.startScroll(paddingLeft, 0, (int) (Gd2.wW * ((float) i)), 0, duration);
            }
        }
    }
        ...
        for (paddingRight = 0; paddingRight < childCount; paddingRight++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams.wX) {
                    b dO = dO(childAt2);
                    if (dO != null) {
                        max = ((int) (dO.wW * ((float) i5))) + paddingLeft;
                        if (layoutParams.wY) {
    ...
    private boolean an(int i) {
        ...
        int i3 = czq.position;
        float f2 = ((((float) i) / ((float) clientWidth)) - czq.wW) / (czq.wV + f);
    ...
    public boolean S(float f, float f2) {
        return (f < ((float) this.wv) && f2 > 0.0f) || (f > ((float) (getWidth() - this.wv)) && f2 < 0.0f);
    }
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (action != -1) {
                    ...
                    if (f == 0.0f || S(this.ww, f) || !a(this, false, (int) f, (int) d, (int) e)) {
        ...
        switch (motionEvent.getAction() & WebView.NORMAL_MODE_ALPHA) {
            ...
            case 1:
                if (this.fU) {
                    ...
                    if (czq != null) {
                        int i = czq.position;
                        f = ((((float) scrollX) / ((float) clientWidth)) - czq.wW) / czq.wV;
                        clientWidth = o.b(motionEvent, this.cF);
                        if (clientWidth < 0) {
                            clientWidth = 0;
                        }
                        if (Math.abs((int) (o.d(motionEvent, clientWidth) - this.vm)) <= this.wA || Math.abs(a) <= this.wy) {
                            clientWidth = (int) ((i >= this.wb ? 0.6f : 0.4f) + (((float) i) + f));
                        } else {
                            clientWidth = a > 0 ? i : i + 1;
                        }
                        if (this.bA.size() > 0) {
                            clientWidth = Math.max(crV(), Math.min(clientWidth, crW()));
                        }
                        a(clientWidth, true, true, a);
                    }
                    this.cF = -1;
                    cP();
            ...
            case 2:
                if (!this.fU) {
                    ...
                    float abs = Math.abs(d - this.ww);
                    f = o.e(motionEvent, clientWidth);
                    x = Math.abs(f - this.wx);
                    if (abs > ((float) this.fW) && abs > x) {
                        this.fU = true;
                        if (d - this.vm > 0.0f) {
    ...
    public int crV() {
        return ((b) this.bA.get(0)).position;
    }

    public int crW() {
        return ((b) this.bA.get(this.bA.size() - 1)).position;
    }
        ...
        if (descendantFocusability != 393216) {
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt.getVisibility() == 0) {
                    b dO = dO(childAt);
                    if (dO != null && dO.position == this.wb) {
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (i3 != childCount) {
            ...
            if (childAt.getVisibility() == 0) {
                b dO = dO(childAt);
                if (dO != null && dO.position == this.wb && childAt.requestFocus(i, rect)) {
                    return true;
                }
            }
            i3 += i2;
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt.getVisibility() == 0) {
                b dO = dO(childAt);
                if (dO != null && dO.position == this.wb && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                    return true;
                }
            }
        }
