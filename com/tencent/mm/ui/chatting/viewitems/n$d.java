...
class n$d extends a {
    ...
    public final n$d s(View view, boolean z) {
        super.dx(view);
        ...
        this.gzp = (ThreeDotsLoadingView) view.findViewById(R.h.loading_view);
        this.oBp = (ImageView) view.findViewById(R.h.cover_iv);
        ...
        this.ubD = (ViewGroup) view.findViewById(R.h.cover_vg);
        return this;
    }
}
