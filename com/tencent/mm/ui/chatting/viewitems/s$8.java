...
class s$8 implements OnClickListener {
    ...
    s$8(s sVar, String str, String str2, int i, int i2, String str3, String str4, int i3) {
        this.ucn = sVar;
        this.ucv = str;
        this.fYG = str2;
        this.ucw = i;
    ...
    public final void onClick(View view) {
        ...
        h.mEJ.h(11608, new Object[]{s.d(this.ucn), this.qiU, Integer.valueOf(this.eaH)});
    }
}
