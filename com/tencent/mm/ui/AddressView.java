...
public class AddressView extends View implements a, d.a {
    ...
    public AddressView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.AVATAR_LAYOUT_WIDTH = getResources().getDimensionPixelSize(R.f.ContactAvatarSize);
        this.AVATAR_WIDTH = getResources().getDimensionPixelSize(R.f.ContactAvatarSize);
        this.NAME_TEXT_SIZE = (float) com.tencent.mm.bp.a.ad(context, R.f.NormalTextSize);
        this.DESCRIPTION_TEXT_SIZE = (float) com.tencent.mm.bp.a.ad(context, R.f.SmallestTextSize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.nameIsSpanned) {
            ...
            canvas.restore();
        } else if (bi.oW(this.description)) {
    ...
    public void resumeAvatarLoad() {
        if (this.avatarDrawable != null) {
            ((com.tencent.mm.pluginsdk.ui.a) this.avatarDrawable).cdh();
        }
    }

    public void stopAvatarLoad() {
        if (this.avatarDrawable != null) {
            ((com.tencent.mm.pluginsdk.ui.a) this.avatarDrawable).cdg();
        }
    }
    ...
    private TextPaint generateOnePaint() {
        ...
        textPaint.setColor(getResources().getColor(R.e.normal_text_color));
        return textPaint;
    }
