...
public final class h implements b {
    ...
    private boolean od(String str) {
        ...
        Assert.assertTrue(z);
        x.d("MicroMsg.SilkFileOperator", "Open file:" + this.aBA + " mode:" + str);
        try {
    ...
    public final g br(int i, int i2) {
        ...
        if (i < 0 || i2 <= 0) {
            ...
            try {
                ...
                x.d("MicroMsg.SilkFileOperator", "DBG: ReadFile[" + this.fileName + "] readOffset:" + i + " readRet:" + read + " fileNow:" + this.aBA.getFilePointer() + " fileSize:" + length);
                if (read < 0) {
                    read = 0;
                }
                gVar.bEG = read;
