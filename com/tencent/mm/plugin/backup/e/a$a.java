...
class a$a {
    ...
    public static String wz(String str) {
        ...
        if (aVar.gVO) {
            ...
            bVar.aT(DownloadSettingTable$Columns.TYPE, aVar.getInt(".msg.appmsg.type"));
            bVar.aT("showtype", aVar.getInt(".msg.appmsg.showtype"));
            bVar.bR("content", (String) aVar.gVN.get(".msg.appmsg.content"));
            bVar.bR(TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_URL, str3);
            ...
            bVar.wB("appattach");
            bVar.wA("mmreader");
            hashMap.put(DownloadSettingTable$Columns.TYPE, wS.type);
            ...
            while (i < list.size()) {
                ...
                if (list.get(i) != null) {
                    ...
                    bVar.bR("title", str3);
                    bVar.bR(TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_URL, str2);
