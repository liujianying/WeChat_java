...
public final class a {
    ...
    static {
        ...
        pVj = Collections.unmodifiableMap(hashMap);
        hashMap = new HashMap();
        ...
        pVk = Collections.unmodifiableMap(hashMap);
        hashMap = new HashMap();
        ...
        pVl = Collections.unmodifiableMap(hashMap);
        hashMap = new HashMap();
        ...
        jGa = Collections.unmodifiableMap(hashMap);
    }

    public static int Ay(int i) {
        Integer num = (Integer) pVj.get(Integer.valueOf(i));
        if (num == null) {
            num = (Integer) pVj.get(Integer.valueOf(-1));
        }
        return num.intValue();
    }

    public static int Az(int i) {
        Integer num = (Integer) pVk.get(Integer.valueOf(i));
        if (num == null) {
            num = (Integer) pVk.get(Integer.valueOf(-1));
        }
        return num.intValue();
    }

    public static int AA(int i) {
        Integer num = (Integer) pVl.get(Integer.valueOf(i));
        if (num == null) {
    ...
    public static int QZ(String str) {
        Integer num = (Integer) jGa.get(str);
        if (num == null) {
            num = Integer.valueOf(-1);
        }
        return num.intValue();
