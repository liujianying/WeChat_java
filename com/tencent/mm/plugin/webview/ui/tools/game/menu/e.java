...
public final class e extends j {
    ...
    private View b(int i, View view, LayoutParams layoutParams) {
        ...
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(this.mContext).inflate(R.i.game_menu_sheet_dialog, null);
        View findViewById = viewGroup.findViewById(R.h.touch_outside);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, viewGroup, false);
        }
        if (bdK()) {
            frameLayout = (FrameLayout) viewGroup.findViewById(R.h.menu_sheet_right_container);
        } else {
            frameLayout = (FrameLayout) viewGroup.findViewById(R.h.menu_sheet_bottom_container);
        }
