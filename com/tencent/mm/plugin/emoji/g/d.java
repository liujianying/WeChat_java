...
public final class d {
    public static ArrayList<EmojiGroupInfo> zH(String str) {
        if (bi.oW(str)) {
        ...
        try {
            ...
            for (int i = 0; i < elementsByTagName.getLength(); i++) {
                ...
                if (!bi.oW(emojiGroupInfo.field_productID)) {
                    emojiGroupInfo.field_recommand = 1;
                    emojiGroupInfo.field_lastUseTime = System.currentTimeMillis();
                    emojiGroupInfo.field_sort = 0;
                    h.mEJ.h(12068, new Object[]{Integer.valueOf(1), emojiGroupInfo.field_productID, Integer.valueOf(emojiGroupInfo.field_recommandType)});
