...
public final class a {
    public static ArrayList<d> a(String str, String str2, String str3, String str4, Map<String, String> map, List<c> list) {
        ...
        com.tencent.mm.y.g.a J = com.tencent.mm.y.g.a.J(str3, str4);
        if (J != null) {
            Map map2 = J.dwm;
            ...
            if (!(map2 == null || map2.isEmpty())) {
                ...
                while (true) {
                    ...
                    cVar.field_step = bi.getInt(str5, 0);
                    list.add(cVar);
                    map.put(str7, str8);
                    i++;
                }
                ...
                while (true) {
                    ...
                    i = bi.getInt((String) map2.get(".msg.appmsg.hardwareinfo.rankview.rankinfolist.rankinfo" + (i2 == 0 ? "" : Integer.valueOf(i2)) + ".score.scoredisplay"), 0);
                    d dVar = new d();
                    dVar.field_appusername = str2;
                    dVar.field_rankID = str;
                    dVar.field_username = str7;
                    dVar.field_ranknum = bi.getInt(str5, 0);
                    dVar.field_score = i;
    ...
    public static void a(String str, String str2, Map<String, String> map) {
        ...
        com.tencent.mm.y.g.a J = com.tencent.mm.y.g.a.J(str, str2);
        if (J != null) {
            Map map2 = J.dwm;
            if (map2 != null && !map2.isEmpty()) {
                String str3;
