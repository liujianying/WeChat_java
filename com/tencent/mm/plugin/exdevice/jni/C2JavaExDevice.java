...
public final class C2JavaExDevice {
    ...
    public static void onAirKissCallback(int i, int i2) {
        x.v(TAG, "onAirKissCallback(errType : %d, errCode : %d)", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        j.aGV().f(0, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
    }
    ...
    public static void onReceiveWCLanDeviceDiscPackage(byte[] bArr) {
        ...
        x.i(str, str2, objArr);
        j.aGV().f(10, new Object[]{bArr});
    }

    public static void onWCLanDeviceUdpError(int i) {
        x.i(TAG, "onWCLanDeviceUdpError, errCode(%d).", new Object[]{Integer.valueOf(i)});
        j.aGV().f(11, new Object[]{Integer.valueOf(i)});
    }
    ...
    public static void onWCLanReceiveResponse(int i, byte[] bArr) {
        ...
        x.i(str, str2, objArr);
        j.aGV().f(12, new Object[]{Integer.valueOf(i), bArr});
    }

    public static void onWCLanDeviceConnectStateNotify(String str, int i) {
        x.i(TAG, "onWCLanDeviceConnectStateNotify, devclassinfo(%s), stateCode(%d).", new Object[]{str, Integer.valueOf(i)});
        j.aGV().f(13, new Object[]{str, Integer.valueOf(i)});
    }
    ...
    public static void onWCLanFileTransferUpdate(int i, byte[] bArr) {
        ...
        objArr[1] = Integer.valueOf(bArr == null ? 0 : bArr.length);
        x.i(str, str2, objArr);
        j.aGV().f(15, new Object[]{Integer.valueOf(i), bArr});
    }
    ...
    public static void onWCLanReceiveNotify(String str, byte[] bArr) {
        ...
        j.aGV().f(16, new Object[]{str, bArr});
    }
}
