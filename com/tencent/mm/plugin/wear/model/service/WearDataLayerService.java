...
public class WearDataLayerService extends WearableListenerService {
    ...
    public final void a(e eVar) {
        x.i("MicroMsg.Wear.WearDataLayerService", "onDataChanged %d %s", new Object[]{Integer.valueOf(eVar.getCount()), eVar.bcQ});
    ...
    public final void a(m mVar) {
        ...
        com.tencent.mm.plugin.wear.model.b.a.L(bundle);
    }
    ...
    public final void a(Channel channel) {
        ...
        File file = new File(com.tencent.mm.compatible.util.e.dgk, g.u(path.getBytes()));
        ...
        try {
            channel.a(new a().bSu(), Uri.fromFile(file));
        } catch (Throwable e2) {
    ...
    public final void b(Channel channel, int i, int i2) {
        ...
        if (i == 0) {
            x.i("MicroMsg.Wear.WearDataLayerService", "onInputClosed %s, %d", new Object[]{r2.getAbsolutePath(), Long.valueOf(new File(com.tencent.mm.compatible.util.e.dgk, g.u(path.getBytes())).length())});
            Bundle bundle = new Bundle();
            bundle.putInt("key_connecttype", 1);
            bundle.putInt("key_funid", b.PT(path));
