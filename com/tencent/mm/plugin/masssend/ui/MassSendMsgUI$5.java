...
class MassSendMsgUI$5 implements a {
    ...
    public final void b(int i, String str, String str2, int i2) {
        ...
        Toast.makeText(this.lbm, this.lbm.getString(R.l.video_export_file_error), 0).show();
        if (MassSendMsgUI.e(this.lbm) != null) {
            MassSendMsgUI.e(this.lbm).dismiss();
            MassSendMsgUI.f(this.lbm);
        }
    }
}
