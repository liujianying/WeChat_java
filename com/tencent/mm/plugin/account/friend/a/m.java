...
public final class m {
    public static String ae(List<NameValuePair> list) {
    ...
    public static boolean cl(Context context) {
        ...
        if (context.getPackageManager().resolveActivity(new Intent("com.tencent.mm.gms.ACTION_CHOOSE_ACCOUNT"), 0) == null || context.getPackageManager().resolveActivity(intent, 0) == null || VERSION.SDK_INT < 8 || context.getSharedPreferences(ad.chY(), 0).getBoolean("googleauth", false)) {
            return false;
        }
        return true;
    }
