...
class FacebookAuthUI$1 extends c<iz> {
    final /* synthetic */ FacebookAuthUI eQg;

    FacebookAuthUI$1(FacebookAuthUI facebookAuthUI) {
    ...
    public final /* synthetic */ boolean a(b bVar) {
        ...
        x.i("MicroMsg.FacebookAuthUI", "summerdiz loginDisasterListener callback content[%s], url[%s]", new Object[]{izVar.bSF.content, izVar.bSF.url});
