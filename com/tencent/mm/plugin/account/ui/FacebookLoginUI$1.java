...
class FacebookLoginUI$1 extends c<iz> {
    final /* synthetic */ FacebookLoginUI eQv;

    FacebookLoginUI$1(FacebookLoginUI facebookLoginUI) {
    ...
    public final /* synthetic */ boolean a(b bVar) {
        ...
        x.i("MicroMsg.FacebookLoginUI", "summerdiz loginDisasterListener callback content[%s], url[%s]", new Object[]{izVar.bSF.content, izVar.bSF.url});
