...
public final class as extends a {
    ...
    public final void a(d dVar, JSONObject jSONObject, int i) {
        ...
        if (jSONObject == null) {
            ...
            dVar.E(i, a.f("setCloseWindowConfirmDialogInfo:fail_invalid_data", null));
            return;
        }
        ...
        if (actionBar != null) {
            ...
            actionBar.setCloseWindowConfirmInfo(bundle);
            dVar.E(i, a.f("setCloseWindowConfirmDialogInfo:ok", null));
        }
    }
}
