...
public final class j extends a {
    ...
    public static void a(d dVar, JSONObject jSONObject, int i, int i2) {
        ...
        if (optString.contains("camera")) {
            if (optInt <= 0) {
                dVar.E(i, com.tencent.mm.plugin.game.gamewebview.a.d.f("chooseVideo:fail", null));
                return;
        ...
        if (i3 == 16 || i3 == 256 || i3 == 4352) {
            if (i2 == 1) {
                x.d("MicroMsg.GameJsApiChooseVideo", " checkPermission checkcamera[%b]", new Object[]{Boolean.valueOf(com.tencent.mm.pluginsdk.permission.a.a(pageActivity, "android.permission.CAMERA", 117, "", ""))});
                if (com.tencent.mm.pluginsdk.permission.a.a(pageActivity, "android.permission.CAMERA", 117, "", "")) {
                    x.d("MicroMsg.GameJsApiChooseVideo", " checkPermission checkMicroPhone[%b]", new Object[]{Boolean.valueOf(com.tencent.mm.pluginsdk.permission.a.a(pageActivity, "android.permission.RECORD_AUDIO", 118, "", ""))});
                    if (!com.tencent.mm.pluginsdk.permission.a.a(pageActivity, "android.permission.RECORD_AUDIO", 118, "", "")) {
                        return;
                    }
                }
                return;
            }
            x.d("MicroMsg.GameJsApiChooseVideo", " checkPermission checkcamera[%b]", new Object[]{Boolean.valueOf(com.tencent.mm.pluginsdk.permission.a.a(pageActivity, "android.permission.CAMERA", 115, "", ""))});
            if (!com.tencent.mm.pluginsdk.permission.a.a(pageActivity, "android.permission.CAMERA", 115, "", "")) {
                return;
            }
        }
        ...
        pageActivity.geJ = new 1(dVar, i);
        if (i2 == 1) {
            com.tencent.mm.bg.d.a(pageActivity, "webview", ".ui.tools.OpenFileChooserUI", intent, 45, false);
        } else {
            com.tencent.mm.bg.d.a(pageActivity, "webview", ".ui.tools.OpenFileChooserUI", intent, 32, false);
        }
    }
}
