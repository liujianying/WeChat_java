...
public final class ao extends a {
    ...
    public final void a(d dVar, JSONObject jSONObject, int i) {
        ...
        boolean equals = bi.oV(jSONObject.optString("reportInstantly")).equals("1");
        boolean equals2 = bi.oV(jSONObject.optString("reportTimeBegin")).equals("1");
        ...
        if (bi.oW(optString)) {
            ...
            dVar.E(i, a.f("reportGamePageTime:fail_invalid_reportId", null));
        }
        if (bi.oW(optString2) && bi.oW(optString3)) {
            ...
            dVar.E(i, a.f("reportGamePageTime:fail_invalid_reportFormatData_reportTabsFormatData", null));
        }
        ...
        dVar.setGamePageReportData(bundle);
        dVar.E(i, a.f("reportGamePageTime:ok", null));
    }
}
