...
public final class bi extends bhd {
    public String eJQ;
        ...
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    biVar.jRj = aVar3.vHC.readString();
                    return 0;
                case 3:
                    biVar.jRK.add(aVar3.vHC.readString());
                    return 0;
                case 4:
                    biVar.eJQ = aVar3.vHC.readString();
                    return 0;
                case 5:
                    IC = aVar3.IC(intValue);
                    size = IC.size();
                    ...
                    return 0;
                case 6:
                    biVar.jRM = aVar3.vHC.rY();
                    return 0;
                case 7:
                    biVar.jRN = aVar3.cJQ();
                    return 0;
                case 8:
                    biVar.jRk = aVar3.vHC.rY();
                    return 0;
                default:
                    return -1;
            }
