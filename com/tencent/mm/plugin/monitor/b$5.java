...
class b$5 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            int i;
            int i2;
            File file = new File(aa.duN + "SdcardInfo.cfg");
            h.mEJ.a(340, file.exists() ? 10 : 11, 1, true);
            boolean ciK = ax.ciK();
            ...
            boolean equals = e.bnC.equals(path2);
            if (equals) {
                j = j9;
                j2 = j8;
                j3 = availableBlocks2;
            ...
            String Wz = ax.Wz(e.bnC);
            String Wz2 = ax.Wz(path);
            ...
            objArr[25] = Wz2;
            x.i(str, str2, objArr);
            h.mEJ.a(340, 0, 1, true);
            h.mEJ.a(340, ciK ? 1 : 2, 1, true);
            h.mEJ.a(340, equals ? 3 : 4, 1, true);
            h hVar = h.mEJ;
            objArr = new Object[2];
            objArr[0] = Integer.valueOf(TbsReaderView$ReaderCallback.GET_BAR_ANIMATING);
            ...
            objArr2[2] = e.bnC;
            objArr2[3] = Wz;
            objArr2[4] = Integer.valueOf(ciK ? 1 : 0);
            ...
            hVar.h(11098, objArr);
            h.mEJ.h(11098, new Object[]{Integer.valueOf(TbsReaderView$ReaderCallback.HIDDEN_BAR), path + ";" + Wz2});
            h.mEJ.h(11098, new Object[]{Integer.valueOf(TbsReaderView$ReaderCallback.SHOW_BAR), e.bnC + ";" + Wz});
            hVar = h.mEJ;
            objArr = new Object[2];
            objArr[0] = Integer.valueOf(TbsReaderView$ReaderCallback.COPY_SELECT_TEXT);
            objArr[1] = Integer.valueOf(file.exists() ? 1 : 0);
            hVar.h(11098, objArr);
            hVar = h.mEJ;
            objArr = new Object[2];
            objArr[0] = Integer.valueOf(TbsReaderView$ReaderCallback.SEARCH_SELECT_TEXT);
            objArr[1] = Integer.valueOf(ciK ? 1 : 0);
            hVar.h(11098, objArr);
            h.mEJ.a(340, 7, 1, true);
        } catch (Throwable e) {
            x.printErrStackTrace("MicroMsg.SubCoreBaseMonitor", e, "reportSDStatus err!", new Object[0]);
            h.mEJ.a(340, 8, 1, true);
        }
    }
}
