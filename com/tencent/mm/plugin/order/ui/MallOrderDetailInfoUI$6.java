...
class MallOrderDetailInfoUI$6 implements OnItemClickListener {
    ...
    public final void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        MallOrderDetailObject$a mallOrderDetailObject$a = (MallOrderDetailObject$a) MallOrderDetailInfoUI.e(this.lPC).get(i);
        if (!TextUtils.isEmpty(mallOrderDetailObject$a.jumpUrl)) {
            c.aD(this.lPC, mallOrderDetailObject$a.jumpUrl);
        }
        MallOrderDetailInfoUI.a(this.lPC, mallOrderDetailObject$a.name);
    }
}
