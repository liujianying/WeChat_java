...
class j$4 implements a {
    ...
    public final int a(String str, int i, keep_ProgressInfo keep_progressinfo, keep_SceneResult keep_sceneresult, boolean z) {
        ...
        if (i == -21006) {
            ...
            j.a(this.icy, str, 4, i);
        } else if (keep_progressinfo != null) {
            j.a(this.icy, str, (long) keep_progressinfo.field_finishedLength, (long) keep_progressinfo.field_toltalLength);
            ...
            if (keep_sceneresult.field_retCode != 0) {
                ...
                j.a(this.icy, str, 4, keep_sceneresult.field_retCode);
            } else {
                x.i("MicroMsg.FileWebNetDownloader", "cdn trans suceess, media id : %s", str);
                j.a(this.icy, str, 3, 0);
            }
        }
        return 0;
    }
