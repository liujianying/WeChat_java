...
public final class p implements z {
    ...
    public final boolean a(int i, int i2, org.b.d.i iVar, String str, List<String> list, arj arj, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        ...
        if (!bi.oW(this.bSw)) {
            ...
            if (jz != null) {
                z2 = axVar.a(c.R(jz), this.nMF, this.title, this.nMD, this.nME);
            }
        }
        if (!z2) {
        ...
        af.byk().bwX();
        this.bGc.finish();
        String zo = ((com.tencent.mm.plugin.emoji.b.c) com.tencent.mm.kernel.g.n(com.tencent.mm.plugin.emoji.b.c.class)).getEmojiMgr().zo(this.nME);
        h.mEJ.h(10993, new Object[]{Integer.valueOf(1), zo});
        return false;
    }
