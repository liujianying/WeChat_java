    ...
    public AsyncMaskImageView(Context context, AttributeSet attributeSet) {
        ...
        super.setOnTouchListener(new OnTouchListener() {
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                if (!AsyncMaskImageView.this.bKe) {
                    return false;
                }
                ...
                switch (motionEvent.getAction()) {
                    case 0:
                        ...
                        view.invalidate();
                        asyncMaskImageView.nLo.removeCallbacks(asyncMaskImageView.nLp);
                        break;
                    case 1:
                    case 3:
                        asyncMaskImageView.nLo.post(asyncMaskImageView.nLp);
                        break;
                }
