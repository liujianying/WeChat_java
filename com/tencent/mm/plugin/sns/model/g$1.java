...
class g$1 extends aa<String, n> {
    ...
    protected final /* synthetic */ void entryRemoved(boolean z, Object obj, Object obj2, Object obj3) {
        ...
        x.d("MicroMsg.LazyerImageLoader2", "evicted: " + z + " key: " + str + " result:" + i + " " + (nVar.bitmap.getRowBytes() * nVar.bitmap.getHeight()) + " " + nVar.bitmap.getWidth() + " " + nVar.bitmap.getHeight() + " oldValue " + (nVar == null ? "NULL" : nVar.FA()) + " newValue: " + (nVar2 == null ? "NULL" : nVar2.FA()));
    }
