...
class HoneyPayReceiveCardUI$8 implements a {
    final /* synthetic */ HoneyPayReceiveCardUI kmc;
    final /* synthetic */ e kmd;

    HoneyPayReceiveCardUI$8(HoneyPayReceiveCardUI honeyPayReceiveCardUI, e eVar) {
    ...
    public final void g(int i, int i2, String str, l lVar) {
        if (this.kmd.kjE.rrT != null) {
            ...
            HoneyPayReceiveCardUI.b(this.kmc);
            c.EF(HoneyPayReceiveCardUI.c(this.kmc));
            this.kmc.finish();
        }
        h.mEJ.e(875, 4, 1);
    }
