...
public class FreeWifiTestActivity extends Activity {
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.h.free_wifi_test_btn1).setOnClickListener(new OnClickListener() {
            public final void onClick(View view) {
                Toast.makeText(ad.getContext(), "test message", 0).show();
            }
        });
        findViewById(R.h.free_wifi_test_btn2).setOnClickListener(new OnClickListener() {
            public final void onClick(View view) {
