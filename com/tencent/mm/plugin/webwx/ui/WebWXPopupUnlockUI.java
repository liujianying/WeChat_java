    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (getIntent() != null) {
            ...
            if (stringExtra != null) {
                ...
                View inflate = View.inflate(this, R.i.extdevice_unlock, null);
                TextView textView = (TextView) inflate.findViewById(R.h.device_name);
                ((TextView) inflate.findViewById(R.h.unlock_bt)).setOnClickListener(new 1(this, dialog));
