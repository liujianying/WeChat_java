...
public class e extends i {
    ...
    public e(PayInfo payInfo, int i) {
        if (payInfo == null) {
            x.e("MicroMsg.NetSceneTenpayQueryOrderInfoByQRCode", "error payinfo is null %s", new Object[]{bi.cjd().toString()});
            this.pfn = "";
        } else {
            this.pfn = payInfo.bOd;
        }
        this.scene = i;
    ...
    public final int aBO() {
        return TbsListener$ErrorCode.DOWNLOAD_OVER_FLOW;
    }
    ...
    public final void a(com.tencent.mm.wallet_core.c.c cVar, JSONObject jSONObject) {
        ...
        h.mEJ.h(15000, new Object[]{Integer.valueOf(i), str, Integer.valueOf(i2)});
    }
    ...
    public final void a(int i, String str, JSONObject jSONObject) {
        try {
            ...
            if (jSONObject2 != null) {
                ...
                com.tencent.mm.plugin.wallet_core.model.o.bOW().prL = jSONObject2.optInt("query_order_time", 5) * TbsLog.TBSLOG_CODE_SDK_BASE;
                com.tencent.mm.plugin.wallet_core.model.o.bOW().mRetryCount = jSONObject2.optInt("query_order_count", 0);
                com.tencent.mm.plugin.wallet_core.model.o.bOW().prM = jSONObject2.optString("default_query_order_wording", "");
            }
            com.tencent.mm.plugin.wallet_core.model.o.bOW().prN = jSONObject.optString("pay_remind_wording");
            ab.a(jSONObject.optJSONObject("bindqueryresp"), this.bVY);
            k kVar = (k) g.l(k.class);
            if (kVar != null) {
            ...
            if (jSONObject.has("real_name_info")) {
                ...
                this.ced = jSONObject2.optString("guide_flag");
                this.cee = jSONObject2.optString("guide_wording");
                this.cef = jSONObject2.optString("left_button_wording");
                this.ceg = jSONObject2.optString("right_button_wording");
                this.ceh = jSONObject2.optString("upload_credit_url");
                this.pfo = jSONObject2.optInt("guide_type", 0);
            }
