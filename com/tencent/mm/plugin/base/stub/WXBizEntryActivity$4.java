...
class WXBizEntryActivity$4 implements a {
    final /* synthetic */ WXBizEntryActivity hdL;

    WXBizEntryActivity$4(WXBizEntryActivity wXBizEntryActivity) {
        this.hdL = wXBizEntryActivity;
    }

    public final void a(int i, int i2, String str, l lVar, boolean z) {
        x.i("MicroMsg.WXBizEntryActivity", "launchWXMiniprogram, DeepLinkHelper.DeepLinkCallback, %d, %d, %s, %b", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), str, Boolean.valueOf(z)});
