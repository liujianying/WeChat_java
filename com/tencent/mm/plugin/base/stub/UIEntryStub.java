...
public class UIEntryStub extends Activity {
    ...
    static /* synthetic */ void a(UIEntryStub uIEntryStub, Bundle bundle) {
        boolean z = false;
        uIEntryStub.rU = bundle.getString("_mmessage_appPackage");
        uIEntryStub.hdG = bundle.getInt("_mmessage_sdkVersion");
        ...
        if (g.cU(queryParameter)) {
            com.tencent.mm.plugin.game.a.a aSm = com.tencent.mm.plugin.game.a.a.a.aSm();
            if (aSm != null) {
                aSm.q(uIEntryStub, queryParameter, uIEntryStub.rU);
            }
        }
        int i = bundle.getInt("_wxapi_command_type");
        x.i("MicroMsg.UIEntryStub", "handle wxapp message: " + uIEntryStub.rU + ", sdkver=" + uIEntryStub.hdG + ", cmd=" + i);
        switch (i) {
            case 1:
                if (au.HX() && !au.Dr()) {
                    c fJ = com.tencent.mm.model.c.c.Jx().fJ("100273");
                    if (fJ.isValid()) {
                        Map ckq = fJ.ckq();
                        if (ckq == null) {
                    ...
                    if (!z) {
                        ...
                        putExtras.putExtra("hardcode_jspermission", JsapiPermissionWrapper.qWa);
                        putExtras.putExtra("hardcode_general_ctrl", GeneralControlWrapper.qVX);
            ...
            case 2:
                ...
                if (sendMessageToWX$Req.message != null && sendMessageToWX$Req.message.getType() == 2) {
                    ...
                    if (!(wXImageObject == null || wXImageObject.checkArgs())) {
                        ...
                        ReportUtil.a(uIEntryStub, ReportUtil.c(uIEntryStub.getIntent().getExtras(), -5));
                        uIEntryStub.finish();
                        return;
                    }
                }
                if (sendMessageToWX$Req.message.getType() != 38 || sendMessageToWX$Req.scene == 1) {
                    if (sendMessageToWX$Req.scene == 1) {
                        ...
                        if (sendMessageToWX$Req.message.getType() == 8) {
                            ...
                            new d(uIEntryStub, queryParameter, sendMessageToWX$Req.openId, new 2(uIEntryStub, bundle, sendMessageToWX$Req)).atx();
                            return;
                        }
                    }
