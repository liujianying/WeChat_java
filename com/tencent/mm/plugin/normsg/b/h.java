...
public final class h {
    ...
    public static <T> T eb(String str, String str2) {
    ...
    public static <T> T a(String str, String str2, Class<?>[] clsArr, Object... objArr) {
        return b(findClass(str), str2, (Class[]) clsArr, objArr);
    }
    ...
    private static Field b(Class<?> cls, String str) {
        LruCache lruCache;
        LruCache lruCache2 = (LruCache) lHe.get(cls.getName());
        if (lruCache2 == null) {
            lruCache2 = new LruCache(30);
            lHe.put(cls.getName(), lruCache2);
            lruCache = lruCache2;
        } else {
            lruCache = lruCache2;
        }
    ...
    private static Method a(Class<?> cls, String str, Class<?>... clsArr) {
        LruCache lruCache;
        LruCache lruCache2 = (LruCache) lHf.get(cls.getName());
        if (lruCache2 == null) {
            lruCache2 = new LruCache(30);
            lHf.put(cls.getName(), lruCache2);
            lruCache = lruCache2;
        } else {
            lruCache = lruCache2;
        }
