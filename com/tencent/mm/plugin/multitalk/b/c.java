...
public final class c extends i<b> {
    public static final String[] diD = new String[]{i.a(b.dhO, "MultiTalkMember"), "CREATE INDEX IF NOT EXISTS idx_MultiTalkMember  on MultiTalkMember  (  wxGroupId )"};

    public c(e eVar) {
        super(eVar, b.dhO, "MultiTalkMember", null);
    }

    public final b dO(String str, String str2) {
        ...
        if (rawQuery != null) {
            try {
                if (rawQuery.moveToNext()) {
                    ...
                    x.i("MicroMsg.MultiTalk.storage.MultiTalkMemberStorage", "getMultiTalkMember get value for memberUuid = %s, wxGroupId = %s, userName = %s, inviteUserName = %s, memberId = %d, status = %d,createTime = %d", new Object[]{Long.valueOf(bVar.field_memberUuid), bVar.field_wxGroupId, bVar.field_userName, bVar.field_inviteUserName, Long.valueOf(bVar.field_memberId), Integer.valueOf(bVar.field_status), Long.valueOf(bVar.field_createTime)});
                    if (rawQuery == null) {
                        return bVar;
                    }
                    rawQuery.close();
    ...
    public final LinkedList<b> HP(String str) {
        ...
        while (rawQuery != null) {
            try {
                ...
                bVar.field_status = rawQuery.getInt(5);
                bVar.field_createTime = rawQuery.getLong(6);
                x.i("MicroMsg.MultiTalk.storage.MultiTalkMemberStorage", "getMultiTalkMemberList get value for memberUuid = %s, wxGroupId = %s, userName = %s, inviteUserName = %s, memberId = %d, status = %d,createTime = %d", new Object[]{Long.valueOf(bVar.field_memberUuid), bVar.field_wxGroupId, bVar.field_userName, bVar.field_inviteUserName, Long.valueOf(bVar.field_memberId), Integer.valueOf(bVar.field_status), Long.valueOf(bVar.field_createTime)});
                linkedList.add(bVar);
            } catch (Exception e) {
                x.e("MicroMsg.MultiTalk.storage.MultiTalkMemberStorage", e.toString());
                return linkedList;
    ...
    public final boolean ca(String str, String str2) {
        ...
        try {
            super.fV("MultiTalkMember", "delete from MultiTalkMember where wxGroupId = \"" + str + "\" and userName = \"" + str2 + "\"");
            return true;
        } catch (Exception e) {
    ...
    public final boolean jy(String str) {
        ...
        try {
            super.fV("MultiTalkMember", "delete from MultiTalkMember where wxGroupId = \"" + str + "\"");
            return true;
        } catch (Exception e) {
