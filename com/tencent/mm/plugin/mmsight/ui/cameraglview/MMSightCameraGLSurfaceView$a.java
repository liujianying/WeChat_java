...
class MMSightCameraGLSurfaceView$a implements EGLConfigChooser {
    ...
    private int[] faP = new int[]{12324, 4, 12323, 4, 12322, 4, 12352, this.EGL_OPENGL_ES2_BIT, 12344};
    protected int faQ = 5;
    protected int faR = 6;
    protected int faS = 5;
    protected int faT = 0;
    ...
    final /* synthetic */ MMSightCameraGLSurfaceView lqT;

    public MMSightCameraGLSurfaceView$a(MMSightCameraGLSurfaceView mMSightCameraGLSurfaceView) {
        this.lqT = mMSightCameraGLSurfaceView;
    }

    public final EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eGLDisplay) {
        int[] iArr = new int[1];
        egl10.eglChooseConfig(eGLDisplay, this.faP, null, 0, iArr);
        int i = iArr[0];
        if (i <= 0) {
            throw new IllegalArgumentException("No configs match configSpec");
        }
        EGLConfig[] eGLConfigArr = new EGLConfig[i];
        egl10.eglChooseConfig(eGLDisplay, this.faP, eGLConfigArr, i, iArr);
