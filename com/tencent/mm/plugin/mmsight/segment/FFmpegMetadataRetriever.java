...
public class FFmpegMetadataRetriever {
    ...
    public int getVideoWidth() {
        try {
            ...
            x.e(TAG, "can not get video width %s", new Object[]{e.getMessage()});
            return 0;
        }
    }
    ...
    public int getVideoRotation() {
        ...
        try {
            ...
            x.e(TAG, "can not get video rotation. %s", new Object[]{e.getMessage()});
            return i;
        }
    }
    ...
    public int getVideoHeight() {
        try {
            ...
            x.d(TAG, "video height %s rotate %s", new Object[]{extractMetadata, extractMetadata2});
            return Integer.valueOf(extractMetadata).intValue();
        } catch (Exception e) {
            x.e(TAG, "can not get video height %s", new Object[]{e.getMessage()});
            return 0;
        }
    }
