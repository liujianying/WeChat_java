...
class d$1 extends BluetoothGattCallback {
    ...
    public final void onConnectionStateChange(BluetoothGatt bluetoothGatt, int i, int i2) {
        x.i("MicroMsg.exdevice.BluetoothLESession", "------onConnectionStateChange------ connect newState = %d, op status = %d, mConnectState = %d", new Object[]{Integer.valueOf(i2), Integer.valueOf(i), Integer.valueOf(this.hgl.hgj)});
        if (!this.hgl.mHandler.sendMessage(this.hgl.mHandler.obtainMessage(4, i2, 0))) {
    ...
    public final void onServicesDiscovered(BluetoothGatt bluetoothGatt, int i) {
        ...
        if (!this.hgl.mHandler.sendMessage(this.hgl.mHandler.obtainMessage(5, i, 0, bluetoothGatt))) {
    ...
    public final void onDescriptorWrite(BluetoothGatt bluetoothGatt, BluetoothGattDescriptor bluetoothGattDescriptor, int i) {
        ...
        if (!this.hgl.mHandler.sendMessage(this.hgl.mHandler.obtainMessage(6, i, 0, bluetoothGatt))) {
    ...
    public final void onCharacteristicChanged(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        ...
        if (!this.hgl.mHandler.sendMessage(this.hgl.mHandler.obtainMessage(8, bluetoothGattCharacteristic.getValue()))) {
    ...
    public final void onCharacteristicWrite(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, int i) {
        ...
        if (!this.hgl.mHandler.sendMessage(this.hgl.mHandler.obtainMessage(7, i, 0))) {
