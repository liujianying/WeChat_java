...
class f$b extends ag {
    private final WeakReference<f> hgm;

    public f$b(Looper looper, f fVar) {
        super(looper);
        this.hgm = new WeakReference(fVar);
    }

    public final void handleMessage(Message message) {
        f fVar = (f) this.hgm.get();
        if (fVar == null) {
        ...
        switch (message.what) {
            ...
            case 5:
                if (!f.a(fVar, (BluetoothGatt) message.obj, message.arg1)) {
                    x.i("MicroMsg.exdevice.BluetoothLESimpleSession", "------disconnect------, mac=%s, name=%s", new Object[]{b.cY(fVar.mSessionId), fVar.fNN.getName()});
