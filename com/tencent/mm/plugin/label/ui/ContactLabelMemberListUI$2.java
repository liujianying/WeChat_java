...
class ContactLabelMemberListUI$2 implements b {
    ...
    public final void a(int i, m mVar, Object obj) {
        ...
        if (ContactLabelMemberListUI.b(this.kBC) != null) {
            ContactLabelMemberListUI.b(this.kBC).removeMessages(5001);
            ContactLabelMemberListUI.b(this.kBC).sendEmptyMessageDelayed(5001, 300);
        }
    }
}
