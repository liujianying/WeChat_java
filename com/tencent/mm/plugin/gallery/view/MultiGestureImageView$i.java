...
class MultiGestureImageView$i extends a {
    final /* synthetic */ MultiGestureImageView jFj;
    float[] jFk = new float[9];
    MultiTouchImageView jFl;

    public MultiGestureImageView$i(MultiGestureImageView multiGestureImageView, MultiTouchImageView multiTouchImageView) {
