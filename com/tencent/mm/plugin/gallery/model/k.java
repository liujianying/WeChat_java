...
public abstract class k implements g {
    ...
    protected abstract String CT(String str);
    ...
    public ArrayList<AlbumItem> aRz() {
        Cursor query;
        ArrayList<AlbumItem> arrayList = new ArrayList();
        try {
            query = this.evN.query(aRB(), getProjection(), getSelection(), null, aRD());
        } catch (Exception e) {
        ...
        if (query.moveToFirst()) {
            do {
                ...
                String string2 = query.getString(query.getColumnIndexOrThrow(aRE()));
                if (bi.oW(string2) && getType() == 2) {
    ...
    protected final synchronized boolean aRG() {
        return this.jBi;
    }
    ...
    public java.util.ArrayList<com.tencent.mm.plugin.gallery.model.GalleryItem.MediaItem> b(java.lang.String r23, int r24, com.tencent.mm.plugin.gallery.model.g.c r25, long r26) {
        ...
        r10 = 0;
        r0 = r22;
        r4 = r0.evN;	 Catch:{ Exception -> 0x0045 }
        r5 = r22.aRB();	 Catch:{ Exception -> 0x0045 }
        r6 = r22.aRC();	 Catch:{ Exception -> 0x0045 }
        r7 = r22.CT(r23);	 Catch:{ Exception -> 0x0045 }
        r8 = 0;
        r9 = r22.aRD();	 Catch:{ Exception -> 0x0045 }
    ...
    L_0x0169:
        r5 = r22.getType();
        r6 = r4.longValue();
        r5 = com.tencent.mm.plugin.gallery.model.GalleryItem.MediaItem.x(r5, r6);
        r4 = com.tencent.mm.sdk.platformtools.bi.oW(r16);
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    protected static long cU(java.lang.String r9, java.lang.String r10) {
        /*
        r8 = 0;
        r0 = 0;
        r4 = java.lang.System.currentTimeMillis();
        r2 = com.tencent.mm.sdk.platformtools.bi.oW(r9);
    ...
    L_0x004d:
        ...
        goto L_0x0027;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.gallery.model.k.cU(java.lang.String, java.lang.String):long");
    }
}
