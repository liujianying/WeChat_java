...
final class c extends a {
    ...
    protected final boolean a(Context context, LaunchParcel launchParcel) {
        ...
        if ((context instanceof AppBrandUI) && !(context instanceof AppBrandPluginUI) && !(context instanceof AppBrandInToolsUI) && ((launchParcel.fqA == null || launchParcel.fqA.fqE != 1) && launchParcel.ghm.scene != 1085)) {
            z = true;
        }
        if (z) {
