        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (jSONObject2 != null) {
                    ...
                    x.d("MicroMsg.JsApiFunc_Log", "ts : %s, level : %d, msg : %s", new Object[]{Util.gS(logInfo.ts), Integer.valueOf(logInfo.level), logInfo.message});
                }
            }
            com.tencent.mm.plugin.appbrand.dynamic.debugger.a.a(aVar.Da().getString("__page_view_id", null), arrayList);
