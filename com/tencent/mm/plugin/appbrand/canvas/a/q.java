...
public final class q implements d {
    ...
    public final boolean a(f fVar, Canvas canvas, JSONArray jSONArray) {
        ...
        if ("linear".equalsIgnoreCase(optString)) {
            ...
            d = com.tencent.mm.plugin.appbrand.q.f.d(optJSONArray, 0);
            d2 = com.tencent.mm.plugin.appbrand.q.f.d(optJSONArray, 1);
            d3 = com.tencent.mm.plugin.appbrand.q.f.d(optJSONArray, 2);
            float d4 = com.tencent.mm.plugin.appbrand.q.f.d(optJSONArray, 3);
            ...
            for (i = 0; i < optJSONArray2.length(); i++) {
                ...
                if (optJSONArray3.length() >= 2) {
                    ...
                    iArr[i] = com.tencent.mm.plugin.appbrand.q.f.h(optJSONArray3.optJSONArray(1));
                }
            }
            ...
            for (i = 0; i < optJSONArray4.length(); i++) {
                ...
                if (optJSONArray2.length() >= 2) {
                    ...
                    iArr2[i] = com.tencent.mm.plugin.appbrand.q.f.h(optJSONArray2.optJSONArray(1));
                }
            }
            ...
            aVar.setShader(null);
            aVar.setColor(com.tencent.mm.plugin.appbrand.q.f.h(optJSONArray));
            ...
            Bitmap aY = fVar.fnl.aY(fVar.doU, optString);
            if (!(aY == null || aY.isRecycled())) {
                Shader bitmapShader;
                int lP = com.tencent.mm.plugin.appbrand.q.f.lP(aY.getWidth());
                int lP2 = com.tencent.mm.plugin.appbrand.q.f.lP(aY.getHeight());
                Object obj = -1;
                ...
                switch (obj) {
                    case null:
                        bitmapShader = new BitmapShader(Bitmap.createScaledBitmap(aY, lP, lP2, false), TileMode.REPEAT, TileMode.REPEAT);
                        break;
                    case 1:
                        createBitmap = Bitmap.createBitmap(lP, lP2 + 1, Config.ARGB_8888);
                        new Canvas(createBitmap).drawBitmap(aY, new Rect(0, 0, aY.getWidth(), aY.getHeight()), new RectF(0.0f, 0.0f, (float) lP, (float) lP2), null);
                        bitmapShader = new BitmapShader(createBitmap, TileMode.REPEAT, TileMode.CLAMP);
                        break;
                    case 2:
                        createBitmap = Bitmap.createBitmap(lP + 1, lP2, Config.ARGB_8888);
                        new Canvas(createBitmap).drawBitmap(aY, new Rect(0, 0, aY.getWidth(), aY.getHeight()), new RectF(0.0f, 0.0f, (float) lP, (float) lP2), null);
                        bitmapShader = new BitmapShader(createBitmap, TileMode.CLAMP, TileMode.REPEAT);
                        break;
                    case 3:
                        createBitmap = Bitmap.createBitmap(lP + 1, lP2 + 1, Config.ARGB_8888);
                        new Canvas(createBitmap).drawBitmap(aY, new Rect(0, 0, aY.getWidth(), aY.getHeight()), new RectF(0.0f, 0.0f, (float) lP, (float) lP2), null);
