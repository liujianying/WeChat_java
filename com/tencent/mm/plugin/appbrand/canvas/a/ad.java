...
public final class ad implements d {
    ...
    public final boolean a(f fVar, Canvas canvas, JSONArray jSONArray) {
        ...
        int a2 = com.tencent.mm.plugin.appbrand.q.f.a(jSONArray, 1);
        int a3 = com.tencent.mm.plugin.appbrand.q.f.a(jSONArray, 2);
        int a4 = com.tencent.mm.plugin.appbrand.q.f.a(jSONArray, 3);
        if (canvas.isHardwareAccelerated()) {
            if (canvas instanceof h) {
                ((h) canvas).e((float) a, (float) a2, (float) (a + a3), (float) (a2 + a4));
            ...
            } else if (fVar.fnk != null) {
                canvas.drawRect((float) a, (float) a2, (float) (a + a3), (float) (a2 + a4), fVar.fnk);
            ...
            canvas.drawRect((float) a, (float) a2, (float) (a + a3), (float) (a2 + a4), fVar.fnj);
        ...
        try {
            ...
            canvas.drawBitmap(bitmap, new Rect(0, 0, bitmap.getWidth(), bitmap.getHeight()), new RectF((float) a, (float) a2, (float) (a + a3), (float) (a2 + a4)), fVar.fnf);
            return true;
        } catch (Throwable e) {
