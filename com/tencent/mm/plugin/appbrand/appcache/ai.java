...
public class ai extends a {
    public static String ag(String str, int i) {
        return ah.abY() + String.format("_%d_%d.wxapkg", new Object[]{Integer.valueOf(str.hashCode()), Integer.valueOf(i)});
    }

    static String qO(String str) {
        return ah.abY() + String.format("_%s.wxapkg", new Object[]{str});
    }
