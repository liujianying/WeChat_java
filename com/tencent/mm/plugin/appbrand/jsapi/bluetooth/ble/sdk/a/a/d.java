...
public final class d extends a {
    ...
    public final void aiu() {
        ...
        if (bluetoothGatt == null) {
            ...
            if (service == null) {
                ...
                if (characteristic == null) {
                ...
                } else if (!b.kH(characteristic.getProperties())) {
                    com.tencent.mm.plugin.appbrand.jsapi.bluetooth.ble.sdk.d.a.e("MicroMsg.Ble.Action", "action:%s, not support notify", this);
                    a(j.fME);
                    done();
                    ...
                    if (!descriptor.setValue(this.bKe ? BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE : BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE)) {
            ...
            com.tencent.mm.plugin.appbrand.jsapi.bluetooth.ble.sdk.d.a.e("MicroMsg.Ble.Action", "action:%s, serviceId is illegal", this);
            a(j.fMB);
            done();
        }
    }
    ...
    public final String toString() {
        return "NotifyCharacteristicAction{serviceId='" + this.fLY + '\'' + ", characteristicId='" + this.fLZ + '\'' + ", enable=" + this.bKe + ", debug=" + this.Zq + ", mainThread=" + this.fLy + ", serial=" + this.fLA + '}';
    }
}
