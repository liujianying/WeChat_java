...
class j$1 implements a$a {
    ...
    public final void run() {
        ...
        YuvImage yuvImage = new YuvImage(j.a(this.mNM), 17, j.b(this.mNM), j.c(this.mNM), null);
        x.d("MicroMsg.scanner.ScanImageDecoder", "decode() compress jpeg by YuvImage");
        OutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        yuvImage.compressToJpeg(new Rect(0, 0, j.b(this.mNM), j.c(this.mNM)), j.d(this.mNM), byteArrayOutputStream);
        this.mNM.mMF = byteArrayOutputStream.toByteArray();
        try {
            FileOutputStream fileOutputStream2;
            if (af.exa) {
                fileOutputStream2 = new FileOutputStream(new File(h.getExternalStorageDirectory().getAbsolutePath() + "/_scanImage.JPEG"));
                try {
                    fileOutputStream2.write(this.mNM.mMF);
                    ...
                    if (fileOutputStream != null) {
                        try {
                            ...
                            x.printErrStackTrace("MicroMsg.scanner.ScanImageDecoder", e422, "", new Object[0]);
                        }
                    }
                    byteArrayOutputStream.close();
                    throw e32;
            ...
            if (fileOutputStream != null) {
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.scanner.ScanImageDecoder", e32222, "", new Object[0]);
                }
            }
            byteArrayOutputStream.close();
        }
