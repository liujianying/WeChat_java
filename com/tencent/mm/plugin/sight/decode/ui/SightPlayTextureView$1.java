...
class SightPlayTextureView$1 implements SurfaceTextureListener {
    ...
    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        SightPlayTextureView.d(this.ndL).d(null);
        SightPlayTextureView.d(this.ndL).clear();
        a aVar = new a((byte) 0);
        aVar.ndM = SightPlayTextureView.e(this.ndL);
        o.d(aVar, 0);
        SightPlayTextureView.a(this.ndL, null);
        return false;
    }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        aVar.ndM = SightPlayTextureView.e(this.ndL);
        o.d(aVar, 0);
        SightPlayTextureView.a(this.ndL, new Surface(surfaceTexture));
        SightPlayTextureView.d(this.ndL).d(SightPlayTextureView.e(this.ndL));
        this.ndL.crS();
    }
}
