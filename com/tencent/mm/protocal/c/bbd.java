    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    bbd.rmr = aVar3.vHC.readFloat();
                    return 0;
                case 2:
                    bbd.rms = aVar3.vHC.readFloat();
                    return 0;
                case 3:
                    bbd.ryV = aVar3.vHC.rY();
                    return 0;
                case 4:
                    bbd.ryW = aVar3.vHC.readString();
                    return 0;
                case 5:
                    bbd.ryX = aVar3.vHC.readString();
                    return 0;
                case 6:
                    bbd.ryY = aVar3.vHC.rY();
                    return 0;
                default:
                    return -1;
            }
