...
public final class aou extends bhp {
    public String jSv;
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            fS += f.a.a.a.c(3, 8, this.rEI);
            if (this.jSv != null) {
                fS += f.a.a.b.b.a.h(4, this.jSv);
            }
            if (this.rbh != null) {
                fS += f.a.a.b.b.a.h(5, this.rbh);
            }
            return fS;
        } else if (i == 2) {
            bArr = (byte[]) objArr[0];
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    return 0;
                case 4:
                    aou.jSv = aVar3.vHC.readString();
                    return 0;
                case 5:
                    aou.rbh = aVar3.vHC.readString();
                    return 0;
                default:
                    return -1;
            }
