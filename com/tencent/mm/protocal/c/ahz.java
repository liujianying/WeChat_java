...
public final class ahz extends bhp {
    public LinkedList<bxh> rGg = new LinkedList();
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            return fS + f.a.a.a.c(2, 8, this.rGg);
        } else if (i == 2) {
            bArr = (byte[]) objArr[0];
            this.rGg.clear();
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        bxh bxh = new bxh();
                        aVar4 = new f.a.a.a.a(bArr, unknownTagHandler);
                        for (z = true; z; z = bxh.a(aVar4, bxh, com.tencent.mm.bk.a.a(aVar4))) {
                        }
                        ahz.rGg.add(bxh);
                    }
                    return 0;
