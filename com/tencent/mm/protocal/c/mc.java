...
public final class mc extends bhp {
    public int hUm;
    public String hUn;
    public int rpW;
    public b rpX;
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.rpX != null) {
                fS += f.a.a.a.a(4, this.rpX);
            }
            return fS + f.a.a.a.fQ(5, this.rpW);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    mcVar.hUm = aVar3.vHC.rY();
                    return 0;
                case 3:
                    mcVar.hUn = aVar3.vHC.readString();
                    return 0;
                case 4:
                    mcVar.rpX = aVar3.cJR();
                    return 0;
                case 5:
                    mcVar.rpW = aVar3.vHC.rY();
                    return 0;
                default:
                    return -1;
            }
