...
public final class ayb extends bhp {
    public bhy saW;
    public pn saX;
    public int saY;
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.saX != null) {
                fS += f.a.a.a.fS(2, this.saX.boi());
            }
            fS += f.a.a.a.fQ(3, this.saY);
            if (this.saW != null) {
                fS += f.a.a.a.fS(4, this.saW.boi());
            }
            return fS;
        } else if (i == 2) {
