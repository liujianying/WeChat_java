...
public final class avx extends bhd {
    public String hbL;
    public String iwP;
    public bhy rYQ;
    public bhy rYR;
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.rYQ == null) {
                ...
                if (this.rYQ != null) {
                    aVar.fV(3, this.rYQ.boi());
                    this.rYQ.a(aVar);
                }
                if (this.rYR != null) {
                    aVar.fV(4, this.rYR.boi());
                    this.rYR.a(aVar);
                }
                if (this.iwP == null) {
                    return 0;
            ...
            if (this.rYQ != null) {
                fS += f.a.a.a.fS(3, this.rYQ.boi());
            }
            if (this.rYR != null) {
                fS += f.a.a.a.fS(4, this.rYR.boi());
            }
            if (this.iwP != null) {
