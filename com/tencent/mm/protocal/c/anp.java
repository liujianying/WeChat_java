...
public final class anp extends a {
    public LinkedList<anq> rQq = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((f.a.a.c.a) objArr[0]).d(1, 8, this.rQq);
            return 0;
        } else if (i == 1) {
            return f.a.a.a.c(1, 8, this.rQq) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = anq.a(aVar3, anq, a.a(aVar3))) {
                            }
                            anp.rQq.add(anq);
                        }
                        return 0;
