...
public final class lj extends a {
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.roC != null) {
                aVar.fV(1, this.roC.boi());
                this.roC.a(aVar);
            }
            if (this.roD != null) {
                aVar.fV(2, this.roD.boi());
                this.roD.a(aVar);
            }
            if (this.roE != null) {
            ...
            if (this.roC != null) {
                fS = f.a.a.a.fS(1, this.roC.boi()) + 0;
            } else {
                fS = 0;
            }
            if (this.roD != null) {
                fS += f.a.a.a.fS(2, this.roD.boi());
            }
            if (this.roE != null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        for (z = true; z; z = kgVar.a(aVar4, kgVar, a.a(aVar4))) {
                        }
                        ljVar.roC = kgVar;
                    }
                    return 0;
                ...
                case 9:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        kfVar = new kf();
                        aVar4 = new f.a.a.a.a(bArr, unknownTagHandler);
                        for (z = true; z; z = kfVar.a(aVar4, kfVar, a.a(aVar4))) {
                        }
                        ljVar.roJ = kfVar;
                    }
                    return 0;
