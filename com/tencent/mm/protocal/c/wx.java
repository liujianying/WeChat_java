...
public final class wx extends a {
    public LinkedList<ww> rBV = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((f.a.a.c.a) objArr[0]).d(1, 8, this.rBV);
            return 0;
        } else if (i == 1) {
            return f.a.a.a.c(1, 8, this.rBV) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = wwVar.a(aVar3, wwVar, a.a(aVar3))) {
                            }
                            wxVar.rBV.add(wwVar);
                        }
                        return 0;
