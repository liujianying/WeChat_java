...
public final class bvo extends bhd {
    public String rcc;
    public int rdV;
    public int rdW;
    public int rdX;
        ...
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    bvo.rcc = aVar3.vHC.readString();
                    return 0;
                case 3:
                    bvo.rdV = aVar3.vHC.rY();
                    return 0;
                case 4:
                    bvo.rdW = aVar3.vHC.rY();
                    return 0;
                case 5:
                    bvo.rdX = aVar3.vHC.rY();
                    return 0;
                case 6:
                    IC = aVar3.IC(intValue);
                    size = IC.size();
