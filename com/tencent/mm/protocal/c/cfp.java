...
public final class cfp extends bhp {
    public int rjC;
    public String rjK;
    public int skR;
    public int syR;
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            return fS + f.a.a.a.fQ(5, this.skR);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    cfp.syR = aVar3.vHC.rY();
                    return 0;
                case 3:
                    cfp.rjC = aVar3.vHC.rY();
                    return 0;
                case 4:
                    cfp.rjK = aVar3.vHC.readString();
                    return 0;
                case 5:
                    cfp.skR = aVar3.vHC.rY();
                    return 0;
                default:
                    return -1;
            }
