...
public final class lz extends a {
    public LinkedList<ly> rqi = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((f.a.a.c.a) objArr[0]).d(1, 8, this.rqi);
            return 0;
        } else if (i == 1) {
            return f.a.a.a.c(1, 8, this.rqi) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = lyVar.a(aVar3, lyVar, a.a(aVar3))) {
                            }
                            lzVar.rqi.add(lyVar);
                        }
                        return 0;
