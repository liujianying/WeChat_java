...
public final class cex extends a {
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.rlw != null) {
                h += f.a.a.b.b.a.h(4, this.rlw);
            }
            return h + f.a.a.a.fQ(5, this.otY);
        } else if (i == 2) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    cex.szk = aVar3.vHC.readString();
                    return 0;
                case 2:
                    cex.rBM = aVar3.vHC.readString();
                    return 0;
                case 3:
                    cex.rwt = aVar3.vHC.readString();
                    return 0;
                case 4:
                    cex.rlw = aVar3.vHC.readString();
                    return 0;
                case 5:
                    cex.otY = aVar3.vHC.rY();
                    return 0;
                default:
                    return -1;
            }
