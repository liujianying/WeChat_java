...
public final class ev extends bhd {
    public long hbZ;
    public int otY;
    public int rfh;
        ...
        if (i == 0) {
            ...
            switch (intValue) {
                ...
                case 3:
                    ...
                    return 0;
                case 4:
                    evVar.rfj = aVar3.vHC.readString();
                    return 0;
                case 5:
                    evVar.rfk = aVar3.vHC.readString();
                    return 0;
                case 6:
                    evVar.otY = aVar3.vHC.rY();
                    return 0;
                case 7:
                    evVar.hbZ = aVar3.vHC.rZ();
                    return 0;
                case 8:
                    evVar.rfl = aVar3.vHC.readString();
                    return 0;
                default:
                    return -1;
            }
