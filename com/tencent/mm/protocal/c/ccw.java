...
public final class ccw extends a {
    public LinkedList<awz> syy = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((f.a.a.c.a) objArr[0]).d(1, 8, this.syy);
            return 0;
        } else if (i == 1) {
            return f.a.a.a.c(1, 8, this.syy) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = awz.a(aVar3, awz, a.a(aVar3))) {
                            }
                            ccw.syy.add(awz);
                        }
                        return 0;
