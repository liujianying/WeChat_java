...
public final class f {
    ...
    public static java.util.Map<java.lang.String, java.lang.String> z(java.lang.String r7, java.lang.String r8) {
        /*
        r6 = 0;
        r0 = 0;
    ...
    L_0x00e0:
        ...
        goto L_0x0067;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.c.f.z(java.lang.String, java.lang.String):java.util.Map<java.lang.String, java.lang.String>");
    }
    ...
    private static void a(Map<String, String> map, String str, String str2, Node node, int i) {
        if (node.getNodeName().equals("#text")) {
            ...
            for (int i3 = 0; i3 < childNodes.getLength(); i3++) {
                ...
                a(map, stringBuilder, str3, item2, i2);
