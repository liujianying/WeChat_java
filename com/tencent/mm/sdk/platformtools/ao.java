...
public final class ao {
    ...
    private static PhoneStateListener sHQ = null;
    private static int sHR = 10000;
    ...
    public static String fG(Context context) {
        ...
        try {
            ...
            x.i("MicroMsg.NetStatusUtil", "netstatus " + stringBuilder.toString());
        } catch (Throwable e) {
            x.i("MicroMsg.NetStatusUtil", e.getMessage());
            x.printErrStackTrace("MicroMsg.NetStatusUtil", e, "", new Object[0]);
        }
    ...
    public static String getNetTypeString(Context context) {
        try {
            ...
            x.d("MicroMsg.NetStatusUtil", "activeNetInfo extra=%s, type=%d", activeNetworkInfo.getExtraInfo(), Integer.valueOf(activeNetworkInfo.getType()));
    ...
    public static String getISPName(Context context) {
        try {
            ...
            x.d("MicroMsg.NetStatusUtil", "getISPName ISPName=%s", telephonyManager.getSimOperatorName());
    ...
    public static boolean is2G(Context context) {
        try {
            ...
            x.d("MicroMsg.NetStatusUtil", "is2G subtype %d", Integer.valueOf(activeNetworkInfo.getSubtype()));
    ...
    public static boolean is4G(Context context) {
        try {
            ...
            x.d("MicroMsg.NetStatusUtil", "is4G subtype %d", Integer.valueOf(activeNetworkInfo.getSubtype()));
            if (activeNetworkInfo.getSubtype() >= 13) {
                return true;
            }
            return false;
    ...
    public static boolean is3G(Context context) {
        try {
            ...
            x.d("MicroMsg.NetStatusUtil", "is3G subtype %d", Integer.valueOf(activeNetworkInfo.getSubtype()));
    ...
    private static Intent searchIntentByClass(Context context, String str) {
        try {
            ...
            if (installedPackages != null && installedPackages.size() > 0) {
                x.e("MicroMsg.NetStatusUtil", "package  size" + installedPackages.size());
                for (int i = 0; i < installedPackages.size(); i++) {
                    try {
                        x.e("MicroMsg.NetStatusUtil", "package " + ((PackageInfo) installedPackages.get(i)).packageName);
                        ...
                        if (size > 0) {
                            try {
                                x.e("MicroMsg.NetStatusUtil", "activityName count " + size);
                        ...
                        x.printErrStackTrace("MicroMsg.NetStatusUtil", e2, "", new Object[0]);
                    }
                }
            }
        } catch (Throwable e22) {
            x.printErrStackTrace("MicroMsg.NetStatusUtil", e22, "", new Object[0]);
        }
        return null;
    }
    ...
    public static boolean fK(Context context) {
        ...
        if (netType == 0 || netType == 10) {
            x.d("MicroMsg.NetStatusUtil", "[cpan] is wifi or 4g network");
            return true;
        }
        x.d("MicroMsg.NetStatusUtil", "[cpan] is mobile network");
        return false;
    }
    ...
    public static synchronized void fL(Context context) {
        synchronized (ao.class) {
            TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
            kpS = telephonyManager.getPhoneType();
            if (sHQ == null) {
                sHQ = new PhoneStateListener() {
                    public final void onSignalStrengthsChanged(SignalStrength signalStrength) {
                        super.onSignalStrengthsChanged(signalStrength);
                        if (ao.kpS == 2) {
                            ao.nowStrength = signalStrength.getCdmaDbm();
                        }
                        if (ao.kpS == 1) {
                            ao.nowStrength = (signalStrength.getGsmSignalStrength() * 2) - 113;
                        }
                        x.i("MicroMsg.NetStatusUtil", "PhoneStateListener  type:%d  strength:%d", Integer.valueOf(ao.kpS), Integer.valueOf(ao.nowStrength));
                    }
                };
                telephonyManager.listen(sHQ, 256);
            }
        }
    }
            ...
            if (context == null) {
                ...
                try {
                    if (getNetTypeForStat(context) == 1) {
                        ...
                        if (sHQ == null) {
                            x.e("MicroMsg.NetStatusUtil", "getStrength phone Listener has not been inited");
                        }
    ...
    public static synchronized List<a> fM(Context context) {
        List<a> list;
        ...
        synchronized (ao.class) {
            if (sHQ == null) {
                ...
                try {
                    ...
                    if (telephonyManager.getPhoneType() == 2) {
                        try {
                            ...
                            if (cdmaCellLocation != null) {
                                str3 = nowStrength == sHR ? "" : nowStrength;
                        ...
                        try {
                            ...
                            if (gsmCellLocation != null) {
                                ...
                                lac = gsmCellLocation.getLac();
                                if (!(lac >= 65535 || lac == -1 || cid == -1)) {
                                    linkedList.add(new a(str, networkOperator, String.valueOf(lac), String.valueOf(cid), nowStrength == sHR ? "" : nowStrength, "gsm", "", "", ""));
                                }
                            }
                        } catch (Throwable e22) {
                            x.printErrStackTrace("MicroMsg.NetStatusUtil", e22, "", new Object[0]);
                        ...
                        if (neighboringCellInfo != null && neighboringCellInfo.size() > 0) {
                            for (NeighboringCellInfo neighboringCellInfo22 : neighboringCellInfo) {
                                if (neighboringCellInfo22.getCid() != -1 && neighboringCellInfo22.getLac() <= 65535) {
                                    ...
                                    x.v("checked", "lac:" + neighboringCellInfo22.getLac() + "  cid:" + neighboringCellInfo22.getCid() + " dbm:" + str3);
                    ...
                    x.printErrStackTrace("MicroMsg.NetStatusUtil", e222, "", new Object[0]);
                    list = linkedList;
                }
            }
        }
