...
public class MultiProcessSharedPreferences extends ContentProvider implements SharedPreferences {
    ...
    private List<SoftReference<OnSharedPreferenceChangeListener>> bX;
    private BroadcastReceiver hiJ;
    private Context mContext;
    private int mMode;
    private String mName;
    private boolean sHM;
    private UriMatcher sHN;
    private Map<String, Integer> sHO;
    ...
    public final class b implements Editor {
        ...
        public final Editor putStringSet(String str, Set<String> set) {
            synchronized (this) {
                this.sHB.put(str, set == null ? null : new HashSet(set));
            }
            return this;
        }
        ...
        private boolean setValue(String str) {
            if (MultiProcessSharedPreferences.this.sHM) {
                return false;
            }
            boolean z;
            synchronized (MultiProcessSharedPreferences.this) {
                MultiProcessSharedPreferences.this.fE(MultiProcessSharedPreferences.this.mContext);
                String[] strArr = new String[]{String.valueOf(MultiProcessSharedPreferences.this.mMode), String.valueOf(this.sHC)};
                synchronized (this) {
                    if (MultiProcessSharedPreferences.this.mContext.getContentResolver().update(Uri.withAppendedPath(Uri.withAppendedPath(MultiProcessSharedPreferences.AUTHORITY_URI, MultiProcessSharedPreferences.this.mName), str), c.o((HashMap) this.sHB), null, strArr) > 0) {
                        z = true;
                    } else {
                        z = false;
                    }
    ...
    private static class c {
        public static ContentValues o(HashMap<String, Object> hashMap) {
            try {
    ...
    private MultiProcessSharedPreferences(Context context, String str, int i) {
        ...
        this.mName = str;
        this.mMode = i;
        this.sHM = context.getPackageManager().isSafeMode();
    }
    ...
    public void registerOnSharedPreferenceChangeListener(OnSharedPreferenceChangeListener onSharedPreferenceChangeListener) {
        synchronized (this) {
            ...
            if (bool != null && bool.booleanValue()) {
                this.bX.add(new SoftReference(onSharedPreferenceChangeListener));
                if (this.hiJ == null) {
                    this.hiJ = new BroadcastReceiver() {
                        public final void onReceive(Context context, Intent intent) {
                            ...
                            if (MultiProcessSharedPreferences.this.mName.equals(intent.getStringExtra("name")) && list != null) {
                                Collection b;
                                synchronized (MultiProcessSharedPreferences.this) {
                                    b = MultiProcessSharedPreferences.this.bX;
                                }
                    ...
                    this.mContext.registerReceiver(this.hiJ, new IntentFilter(Wu(this.mName)));
                }
            }
        }
    }
    ...
    public void unregisterOnSharedPreferenceChangeListener(OnSharedPreferenceChangeListener onSharedPreferenceChangeListener) {
        synchronized (this) {
            ...
            if (this.bX != null) {
                ...
                for (SoftReference softReference : this.bX) {
                ...
                for (SoftReference softReference2 : arrayList) {
                    this.bX.remove(softReference2);
                }
                if (this.bX.isEmpty() && this.hiJ != null) {
                    this.mContext.unregisterReceiver(this.hiJ);
                    this.hiJ = null;
                    this.bX = null;
                }
            }
    ...
    public boolean onCreate() {
        fE(getContext());
        this.sHN = new UriMatcher(-1);
        this.sHN.addURI(AUTHORITY, "*/getAll", 1);
        this.sHN.addURI(AUTHORITY, "*/getString", 2);
        this.sHN.addURI(AUTHORITY, "*/getInt", 3);
        this.sHN.addURI(AUTHORITY, "*/getLong", 4);
        this.sHN.addURI(AUTHORITY, "*/getFloat", 5);
        this.sHN.addURI(AUTHORITY, "*/getBoolean", 6);
        this.sHN.addURI(AUTHORITY, "*/contains", 7);
        this.sHN.addURI(AUTHORITY, "*/apply", 8);
        this.sHN.addURI(AUTHORITY, "*/commit", 9);
        this.sHN.addURI(AUTHORITY, "*/registerOnSharedPreferenceChangeListener", 10);
        this.sHN.addURI(AUTHORITY, "*/unregisterOnSharedPreferenceChangeListener", 11);
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        switch (this.sHN.match(uri)) {
            ...
            case 10:
                ciw();
                num = (Integer) this.sHO.get(str3);
                parseInt = (num == null ? 0 : num.intValue()) + 1;
                this.sHO.put(str3, Integer.valueOf(parseInt));
                num2 = (Integer) this.sHO.get(str3);
                str4 = "value";
            ...
            case 11:
                ...
                this.sHO.remove(str3);
                String str6 = "value";
                if (this.sHO.containsKey(str3)) {
                    z = false;
                }
