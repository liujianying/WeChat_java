...
public class aa<K, V> {
    ...
    public final synchronized boolean ce(K k) {
        boolean z;
        if (get(k) != null) {
            z = true;
        } else {
    ...
    L_0x0057:
        ...
        goto L_0x001b;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.sdk.platformtools.aa.get(java.lang.Object):V");
    }
    ...
    L_0x0044:
        ...
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.sdk.platformtools.aa.trimToSize(int):void");
    }
