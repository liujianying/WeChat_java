...
public class ag implements com.tencent.mm.sdk.platformtools.ai.a {
    ...
    public ag() {
        ...
        if (getLooper().getThread().getName().equals("initThread")) {
            x.e(TAG, "MMHandler can not init handler with initThread looper, stack %s", bi.cjd());
        }
    }
    ...
    public final void removeCallbacks(Runnable runnable, Object obj) {
        if (runnable != null) {
            WeakReference weakReference = (WeakReference) this.map.get(runnable);
            if (!(weakReference == null || weakReference.get() == null || (obj != null && ((am) weakReference.get()).sHc != obj))) {
        ...
        if (it != null) {
            while (it.hasNext()) {
                ...
                if (entry != null) {
                    ...
                    if (!(weakReference == null || weakReference.get() == null || ((am) weakReference.get()).sHc != obj)) {
                        it.remove();
                    }
                }
            }
        ...
        if (it != null) {
            while (it.hasNext()) {
                ...
                if (!(weakReference == null || weakReference.get() == null)) {
                    ...
                    if (amVar.started && amVar.dFc >= amVar.sHf && currentTimeMillis - amVar.dFc > j) {
