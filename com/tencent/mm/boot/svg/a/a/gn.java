    ...
    protected final int b(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                a = c.a(i2, looper);
                a.setColor(-15028967);
                e = c.a(e, -1.0f, 0.0f, 92.0f, 0.0f, 1.0f, 0.0f);
                f.reset();
                f.setValues(e);
                canvas.concat(f);
                j = c.j(looper);
                j.moveTo(13.652f, 52.567215f);
                j.cubicTo(12.7396f, 52.567215f, 12.0f, 51.936596f, 12.0f, 51.15864f);
                j.cubicTo(12.0f, 50.38062f, 12.7396f, 49.75f, 13.652f, 49.75f);
                j.lineTo(66.348f, 49.75f);
                j.cubicTo(67.2604f, 49.75f, 68.0f, 50.38062f, 68.0f, 51.158573f);
                j.cubicTo(68.0f, 51.936527f, 67.2604f, 52.567215f, 66.348f, 52.567215f);
                j.lineTo(13.652f, 52.567215f);
                j.close();
                j.moveTo(77.994f, 68.137474f);
                j.lineTo(14.0060005f, 68.137474f);
                j.cubicTo(12.898087f, 68.137474f, 12.0f, 67.50686f, 12.0f, 66.728905f);
                j.lineTo(12.0f, 66.728836f);
                j.cubicTo(12.0f, 65.95088f, 12.898087f, 65.32026f, 14.0060005f, 65.32026f);
                j.lineTo(77.994f, 65.32026f);
                j.cubicTo(79.10191f, 65.32026f, 80.0f, 65.95088f, 80.0f, 66.728836f);
                j.lineTo(80.0f, 66.728905f);
                j.cubicTo(80.0f, 67.50686f, 79.10191f, 68.137474f, 77.994f, 68.137474f);
                j.lineTo(77.994f, 68.137474f);
                j.close();
                j.moveTo(46.024593f, 83.0f);
                j.lineTo(13.975407f, 83.0f);
                j.cubicTo(12.884389f, 83.0f, 12.0f, 82.36937f, 12.0f, 81.59139f);
                j.lineTo(12.0f, 81.59139f);
                j.cubicTo(12.0f, 80.813416f, 12.884389f, 80.182785f, 13.975407f, 80.182785f);
                j.lineTo(46.024593f, 80.182785f);
                j.cubicTo(47.115612f, 80.182785f, 48.0f, 80.813416f, 48.0f, 81.59139f);
                j.lineTo(48.0f, 81.59139f);
                j.cubicTo(47.9999f, 82.36937f, 47.115513f, 83.0f, 46.024593f, 83.0f);
                j.lineTo(46.024593f, 83.0f);
                j.close();
                WeChatSVGRenderC2Java.setFillType(j, 2);
                canvas.drawPath(j, a);
                canvas.restore();
