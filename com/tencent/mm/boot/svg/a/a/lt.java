    ...
    protected final int b(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                canvas.save();
                e = c.a(e, 1.0f, 0.0f, -569.0f, 0.0f, 1.0f, -597.0f);
                f.reset();
                f.setValues(e);
                canvas.concat(f);
                canvas.save();
                float[] a2 = c.a(e, 1.0f, 0.0f, 569.0f, 0.0f, 1.0f, 597.0f);
                f.reset();
                f.setValues(a2);
                canvas.concat(f);
                Paint a3 = c.a(i2, looper);
                a3.setColor(1275068416);
                canvas.save();
                ...
                canvas.restore();
                canvas.save();
                e = c.a(a2, 1.0f, 0.0f, 90.0f, 0.0f, 1.0f, 200.0f);
                f.reset();
                f.setValues(e);
                canvas.concat(f);
                canvas.restore();
