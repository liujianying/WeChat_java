...
public final class jy extends c {
    private final int height = i$l.AppCompatTheme_checkboxStyle;
    private final int width = i$l.AppCompatTheme_checkboxStyle;

    protected final int b(int i, Object... objArr) {
        switch (i) {
            case 0:
                return i$l.AppCompatTheme_checkboxStyle;
            case 1:
                return i$l.AppCompatTheme_checkboxStyle;
            case 2:
