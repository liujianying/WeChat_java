    ...
    public static void a(Bitmap bitmap, CompressFormat compressFormat, String str) {
        ...
        try {
            ...
            try {
                ...
                x.i("MicroMsg.VideoUtil", "recycle bitmap:%s", new Object[]{bitmap.toString()});
                bitmap.recycle();
            ...
            if (fileOutputStream != null) {
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.VideoUtil", e22222, "", new Object[0]);
                }
            }
            x.i("MicroMsg.VideoUtil", "recycle bitmap:%s", new Object[]{bitmap.toString()});
            bitmap.recycle();
            ...
            if (fileOutputStream != null) {
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.VideoUtil", e222222, "", new Object[0]);
                }
            }
            x.i("MicroMsg.VideoUtil", "recycle bitmap:%s", new Object[]{bitmap.toString()});
            bitmap.recycle();
            ...
            if (fileOutputStream != null) {
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.VideoUtil", e2222222, "", new Object[0]);
                }
            }
            x.i("MicroMsg.VideoUtil", "recycle bitmap:%s", new Object[]{bitmap.toString()});
            bitmap.recycle();
            ...
            if (fileOutputStream != null) {
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.VideoUtil", e42, "", new Object[0]);
                }
            }
            x.i("MicroMsg.VideoUtil", "recycle bitmap:%s", new Object[]{bitmap.toString()});
            bitmap.recycle();
