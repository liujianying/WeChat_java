...
public final class d {
    public static final String a(ContentResolver contentResolver, Uri uri) {
        ...
        if (bi.oW(b)) {
            b = "share_file" + Tu(type);
        }
        File file = new File(e.dgj, b);
        if (FileOp.cn(file.getAbsolutePath())) {
        ...
        try {
            ...
            try {
                ...
                if (openInputStream == null) {
                    com.tencent.mm.a.e.f(openInputStream);
    ...
    public static final String a(ContentResolver contentResolver, Uri uri, int i) {
        ...
        String absolutePath = new File(ad.getContext().getCacheDir(), "share_img_tmp_" + i + Tu(contentResolver.getType(uri))).getAbsolutePath();
        if (FileOp.cn(absolutePath)) {
