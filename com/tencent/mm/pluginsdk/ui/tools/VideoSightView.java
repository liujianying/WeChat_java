    ...
    public final boolean q(Context context, boolean z) {
        ...
        if (this.nck == null) {
            ...
            try {
                ...
                h.bA(context, context.getResources().getString(a$h.video_file_play_faile));
            }
            this.nGM = true;
            return false;
        } else {
            ...
            setOnDecodeDurationListener(new b$f() {
                public final void b(b bVar, long j) {
                    ...
                    if (VideoSightView.this.ndD != null) {
                        x.v("MicroMsg.VideoSightView", "onPlayTime, currentTime: %s, duration: %s", new Object[]{Long.valueOf(j), Integer.valueOf(VideoSightView.this.duration)});
                        VideoSightView.this.ndD.ck((int) j, VideoSightView.this.duration);
                    }
                }
            });
        } else {
