...
public class ChatFooterBottom extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        x.d("MicroMsg.ChatFooterBottom", "jacks onMeasure  width:%d, height:%d, isHide: %B", new Object[]{Integer.valueOf(MeasureSpec.getSize(i)), Integer.valueOf(MeasureSpec.getSize(i2)), Boolean.valueOf(this.ccw)});
        if (this.ccw) {
            setVisibility(8);
