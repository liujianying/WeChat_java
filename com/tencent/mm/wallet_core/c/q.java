...
public final class q {
    ...
    public static long uXu = 0;

    public static void cDf() {
        uXu = System.currentTimeMillis();
    }

    public static int cDg() {
        return (int) ((System.currentTimeMillis() - uXu) / 1000);
    }
                ...
                if (Character.isDigit(str3.charAt(0))) {
                    ...
                    while (i2 < str5.length()) {
                        try {
                            ...
                            h.mEJ.h(10756, new Object[]{str, str2, str5, str6, Integer.valueOf(i), str4});
                        }
                    }
                }
                str5 = str3;
    ...
    public static void fu(int i, int i2) {
        h.mEJ.h(12097, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Long.valueOf(System.currentTimeMillis())});
    }

    public static void a(int i, int i2, int i3, int i4, long j, int i5, String str) {
        IDKey iDKey;
        if (fv(i, i2) || fw(i, i2) || fx(i, i2) || Ha(i) || fy(i, i2)) {
            ...
            if (i5 == 4) {
                ...
                i6 = com.tencent.mm.plugin.appbrand.jsapi.x.CTRL_INDEX;
