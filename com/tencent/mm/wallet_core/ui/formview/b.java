...
public final class b {
    ...
    private static final int uZv = f.wallet_date_dialog_tag_id;
    ...
    public static void f(MMActivity mMActivity, WalletFormView walletFormView) {
        walletFormView.setOnClickListener(new 1(mMActivity, walletFormView));
    }

    public static void a(MMActivity mMActivity, int i, int i2) {
        if (i != -1) {
            mMActivity.addDialog(com.tencent.mm.wallet_core.ui.b.a(mMActivity, i, mMActivity.getResources().getString(i2), mMActivity.getResources().getString(i.wallet_i_know_it), new 2()));
        }
    }
}
