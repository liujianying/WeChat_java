...
public class SFSOutputStream extends OutputStream {
    private StackTraceElement[] eeS = Thread.currentThread().getStackTrace();
    ...
    protected void finalize() {
        if (this.mNativePtr != 0) {
            ...
            for (StackTraceElement stackTraceElement : this.eeS) {
                stringBuilder.append(stackTraceElement.toString()).append(10);
            }
            x.e("MicroMsg.SFSOutputStream", stringBuilder.toString());
            close();
        }
        super.finalize();
    }
