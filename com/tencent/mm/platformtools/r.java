...
public final class r {
    public static boolean a(String str, Context context, int i) {
        ...
        if (!bi.oW(str)) {
            String oN = oN("gif");
            e.cs(oN);
            if (FileOp.y(str, oN) >= 0) {
                a(oN, context);
                Toast.makeText(context, context.getString(i, new Object[]{Vs()}), 1).show();
                return true;
            }
        }
        return false;
    ...
    L_0x000d:
        r2 = "jpg";
        r5 = oN(r2);
        com.tencent.mm.a.e.cs(r5);
        r2 = com.tencent.mm.modelsfs.FileOp.y(r9, r5);
        r6 = 0;
    ...
    L_0x0028:
        r2 = 0;
        r4 = com.tencent.mm.sdk.platformtools.BackwardSupportUtil.ExifHelper.VX(r5);	 Catch:{ Exception -> 0x0073, all -> 0x0080 }
        r3 = com.tencent.mm.sdk.platformtools.MMNativeJpeg.decodeAsBitmap(r5);	 Catch:{ Exception -> 0x0073, all -> 0x0080 }
        if (r3 == 0) goto L_0x0094;
    L_0x0033:
        r4 = (float) r4;
        r3 = com.tencent.mm.sdk.platformtools.c.b(r3, r4);	 Catch:{ Exception -> 0x0064, all -> 0x0080 }
        r4 = r3;
    L_0x0039:
    ...
    L_0x0094:
        ...
        goto L_0x0045;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.platformtools.r.a(java.lang.String, android.content.Context, boolean, int):boolean");
    }

    public static String oN(String str) {
        return com.tencent.mm.compatible.util.e.dgl + String.format("%s%d.%s", new Object[]{"mmexport", Long.valueOf(System.currentTimeMillis()), str});
    }
