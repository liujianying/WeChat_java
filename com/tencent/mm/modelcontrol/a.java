...
public final class a {
    private static f[] dQu;

    static {
        dQu = null;
        r8 = new f[2];
        dQu = r8;
        r8[0] = new f(0, TbsListener$ErrorCode.DOWNLOAD_HAS_LOCAL_TBS_ERROR, 540, 960, 30, 1200000, 1200000);
        dQu[1] = new f(TbsListener$ErrorCode.DOWNLOAD_HAS_LOCAL_TBS_ERROR, TbsListener$ErrorCode.ERROR_CODE_LOAD_BASE, 360, 640, 24, 544000, 544000);
    }
    ...
    L_0x0006:
        r10 = dQu;	 Catch:{ Exception -> 0x020f }
    L_0x0008:
        ...
        r0 = r11.fps;	 Catch:{ Exception -> 0x020f }
        r12.fps = r0;	 Catch:{ Exception -> 0x020f }
        r0 = r11.videoBitrate;	 Catch:{ Exception -> 0x020f }
        r12.videoBitrate = r0;	 Catch:{ Exception -> 0x020f }
    ...
    L_0x002d:
        ...
        r6 = r6.dQM;	 Catch:{ Exception -> 0x020f }
        if (r0 < r6) goto L_0x0044;
    L_0x0039:
        r0 = r12.duration;	 Catch:{ Exception -> 0x020f }
        r6 = dQu;	 Catch:{ Exception -> 0x020f }
        r8 = 1;
    ...
    L_0x0048:
        ...
        r0 = r0.dQL;	 Catch:{ Exception -> 0x020f }
        if (r5 < r0) goto L_0x0116;
    L_0x004e:
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.dQM;	 Catch:{ Exception -> 0x020f }
        if (r5 >= r0) goto L_0x0116;
    L_0x0054:
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r0.dQN;	 Catch:{ Exception -> 0x020f }
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.dQO;	 Catch:{ Exception -> 0x020f }
    ...
    L_0x007f:
        r12.height = r0;	 Catch:{ Exception -> 0x020f }
        r0 = r12.fps;	 Catch:{ Exception -> 0x020f }
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.dQP;	 Catch:{ Exception -> 0x020f }
        if (r0 <= r1) goto L_0x0112;
    L_0x0089:
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.dQP;	 Catch:{ Exception -> 0x020f }
    L_0x008d:
        r12.fps = r0;	 Catch:{ Exception -> 0x020f }
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.dQQ;	 Catch:{ Exception -> 0x020f }
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.dQM;	 Catch:{ Exception -> 0x020f }
        r0 = r0 * r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.dQR;	 Catch:{ Exception -> 0x020f }
        r3 = r12.duration;	 Catch:{ Exception -> 0x020f }
        r1 = r1 * r3;
        r0 = r0 + r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.dQQ;	 Catch:{ Exception -> 0x020f }
        r3 = r12.duration;	 Catch:{ Exception -> 0x020f }
        r1 = r1 * r3;
        r0 = r0 - r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        ...
        r3 = r3.dQL;	 Catch:{ Exception -> 0x020f }
        r1 = r1 * r3;
        r0 = r0 - r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.dQM;	 Catch:{ Exception -> 0x020f }
        ...
        r4 = r4 * r8;
        r3 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r3 = r3.dQN;	 Catch:{ Exception -> 0x020f }
        r7 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r7 = r7.dQO;	 Catch:{ Exception -> 0x020f }
        r3 = r3 * r7;
        r8 = (double) r3;	 Catch:{ Exception -> 0x020f }
        r4 = r4 / r8;
        r4 = java.lang.Math.sqrt(r4);	 Catch:{ Exception -> 0x020f }
        r0 = r0 * r4;
        r3 = r12.fps;	 Catch:{ Exception -> 0x020f }
        r4 = (double) r3;	 Catch:{ Exception -> 0x020f }
        r0 = r0 * r4;
        r3 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r3 = r3.dQP;	 Catch:{ Exception -> 0x020f }
        r4 = (double) r3;	 Catch:{ Exception -> 0x020f }
        r0 = r0 / r4;
        r4 = 4607182418800017408; // 0x3ff0000000000000 float:0.0 double:1.0;
        r3 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r3 = r3.dQP;	 Catch:{ Exception -> 0x020f }
        r6 = r12.fps;	 Catch:{ Exception -> 0x020f }
        r3 = r3 - r6;
        ...
        r12.videoBitrate = r0;	 Catch:{ Exception -> 0x020f }
        r0 = r12.videoBitrate;	 Catch:{ Exception -> 0x020f }
    L_0x00f7:
        return r0;
    L_0x00f8:
        r0 = 0;
