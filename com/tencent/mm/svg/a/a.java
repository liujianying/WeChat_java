...
public final class a {
    ...
    private static Map<Integer, c> teO = new ConcurrentHashMap();
    ...
    private static Drawable a(Resources resources, int i, float f) {
        ...
        if (i == 0) {
            ...
            if (f > 0.0f) {
                ...
                picture = (Picture) teQ.get(str4);
                if (picture == null) {
                    picture = a(f2, a(resources, i, str), f3);
                    teQ.put(str4, picture);
                }
                return new c(picture, i);
            }
            picture = (Picture) teP.get(Integer.valueOf(i));
            if (picture == null) {
                picture = a(f2, a(resources, i, str), f3);
                teP.put(Integer.valueOf(i), picture);
            }
            return new c(picture, i);
        }
    }
        ...
        try {
            if (resources.getResourceTypeName(i).equals("raw")) {
                ...
                synchronized (this.teK) {
                    TypedValue typedValue = this.teJ;
                    if (typedValue == null) {
    ...
    public static Map<Integer, c> cog() {
        return teO;
    }
        ...
        try {
            ...
            if (openRawResource != null) {
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.SVGCompat", e, "", new Object[0]);
                }
            }
            ...
            float f2 = resources.getDisplayMetrics().density;
            float f3 = (f > 0.0f ? f : 1.0f) * ((viewPort[0] / ((float) teM)) * f2);
            float f4 = (viewPort[1] / ((float) teM)) * f2;
            if (f <= 0.0f) {
                f = 1.0f;
            }
            float f5 = f4 * f;
            ...
            x.printErrStackTrace("MicroMsg.SVGCompat", e2, "", new Object[0]);
            com.tencent.mm.svg.b.c.e("MicroMsg.SVGCompat", "Get SVGPictureDrawable failed. Reason : IOException", new Object[0]);
            if (openRawResource != null) {
                try {
                    openRawResource.close();
                } catch (Throwable e22) {
                    x.printErrStackTrace("MicroMsg.SVGCompat", e22, "", new Object[0]);
                }
            }
            return null;
        } catch (Throwable th) {
            if (openRawResource != null) {
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.SVGCompat", e3, "", new Object[0]);
                }
            }
        }
    }
    ...
    private static c a(Resources resources, int i, String str) {
        Object obj = "";
        try {
            if (teO.containsKey(Integer.valueOf(i))) {
                return (c) teO.get(Integer.valueOf(i));
            }
            ...
            teO.put(Integer.valueOf(i), cVar);
            return cVar;
        } catch (Throwable e) {
            x.printErrStackTrace("MicroMsg.SVGCompat", e, "", new Object[0]);
    ...
    private static Picture a(float f, c cVar, float f2) {
        ...
        if (cVar == null) {
            ...
            if (teR == null) {
                teR = Float.valueOf(f / ((float) teM));
            }
            float floatValue = teR.floatValue() * f2;
