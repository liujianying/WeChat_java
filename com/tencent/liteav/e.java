...
public class e extends m implements a, h.a, com.tencent.liteav.network.e, b.a, j {
    ...
    private void g() {
        if (this.q == null) {
            ...
            this.q.a(i);
            this.q.a(new com.tencent.liteav.a.a.b() {
    ...
    private void p() {
        ...
        if (this.e != null) {
            int i2;
            bundle.putInt("CACHE_SIZE", (int) this.e.c());
            bundle.putInt("CODEC_CACHE", (int) this.e.b());
            bundle.putInt("VIDEO_CACHE_SIZE", (int) this.e.d());
            bundle.putInt("V_DEC_CACHE_SIZE", this.e.e());
            bundle.putInt("AV_PLAY_INTERVAL", (int) this.e.f());
            bundle.putString("AUDIO_PLAY_INFO", this.e.k());
            bundle.putInt("NET_JITTER", this.e.g());
            bundle.putInt("AV_RECV_INTERVAL", (int) this.e.h());
            bundle.putFloat("AUDIO_PLAY_SPEED", this.e.i());
            if (i == 0) {
                i2 = 15;
            } else {
                i2 = i;
            }
            bundle.putInt("VIDEO_GOP", (int) (((double) (((float) ((this.e.j() * 10) / i2)) / 10.0f)) + 0.5d));
        }
