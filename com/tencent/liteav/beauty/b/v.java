    ...
    public void a(int i, FloatBuffer floatBuffer, FloatBuffer floatBuffer2) {
        ...
        if (this.t) {
            ...
            while (true) {
                ...
                if (this.r[i3] != null) {
                    GLES20.glBindTexture(3553, this.r[i3].d[0]);
                    GLES20.glUniform1i(this.c, 0);
                    GLES20.glVertexAttribPointer(this.b, 2, 5126, false, 8, this.r[i3].a);
                    GLES20.glEnableVertexAttribArray(this.b);
                    GLES20.glVertexAttribPointer(this.d, 4, 5126, false, 16, this.r[i3].b);
                    GLES20.glEnableVertexAttribArray(this.d);
