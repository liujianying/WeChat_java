...
public class a implements AutoFocusCallback {
        ...
        if (this.q) {
            try {
                ...
                if (this.n) {
                    ...
                    arrayList.add(new Area(a(f, f2, 2.0f), TbsLog.TBSLOG_CODE_SDK_BASE));
                    parameters.setFocusAreas(arrayList);
                }
                if (this.o) {
                    arrayList = new ArrayList();
                    arrayList.add(new Area(a(f, f2, 3.0f), TbsLog.TBSLOG_CODE_SDK_BASE));
    ...
    private Rect a(float f, float f2, float f3) {
        ...
        if (i5 <= TbsLog.TBSLOG_CODE_SDK_BASE) {
            i3 = i5;
        }
