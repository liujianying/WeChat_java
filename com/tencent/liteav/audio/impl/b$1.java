...
class b$1 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (!intent.hasExtra(OpenSDKTool4Assistant.EXTRA_STATE)) {
        } else {
            if (intent.getIntExtra(OpenSDKTool4Assistant.EXTRA_STATE, 0) == 0) {
                ...
                TXCLog.d(b.b(), "耳机拔出");
            } else if (1 == intent.getIntExtra(OpenSDKTool4Assistant.EXTRA_STATE, 0)) {
                if (b.a(this.a) != null) {
                    b.a(this.a).OnHeadsetState(true);
                }
                TXCLog.d(b.b(), "耳机插入");
