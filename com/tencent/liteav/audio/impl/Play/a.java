...
public class a implements Runnable {
            ...
            if (isEmpty) {
                ...
                if (this.c != null) {
                    try {
                        ...
                        i = 1;
                        try {
                            dequeueInputBuffer = this.c.dequeueInputBuffer(10000);
                ...
                if (aVar.d == com.tencent.liteav.basic.a.a.k) {
                    ...
                    a(aVar, byteBufferArr, dequeueInputBuffer);
                } else {
    ...
    private int b(com.tencent.liteav.basic.f.a aVar) {
        ...
        int a = com.tencent.liteav.audio.impl.a.a(((aVar.f[0] & 7) << 1) | ((aVar.f[1] & 128) >> 7));
                    ...
                    while (true) {
                        try {
                            ...
                            try {
                                this.c.start();
                                break;
                            } catch (CodecException e52) {
                                e2 = e52;
                                i2 = 1;
                            }
                        } catch (CodecException e62) {
                            e2 = e62;
                            i2 = 0;
                            TXCLog.e(a, "CodecException: " + e2 + ". step: " + i2 + ", mediaformat: " + this.e);
                            i++;
            ...
            while (true) {
                try {
                    ...
                    try {
                        this.c.start();
                        break;
                    } catch (CodecException e522) {
                        e2 = e522;
                        i2 = 1;
                    }
                } catch (CodecException e622) {
                    e2 = e622;
                    i2 = 0;
                    TXCLog.e(a, "CodecException: " + e2 + ". step: " + i2 + ", mediaformat: " + this.e);
                    i++;
                    if (i > 1) {
                        ...
                        try {
                            Thread.sleep(20);
                        } catch (InterruptedException e822) {
                        }
                    } else {
                        TXCLog.e(a, "decoder cath unrecoverable error!");
                        this.c.release();
        ...
        while (true) {
            try {
                ...
                try {
                    this.c.start();
                    break;
                } catch (IllegalStateException e922) {
                    e3 = e922;
                    i2 = 1;
                }
            } catch (IllegalStateException e1022) {
                e3 = e1022;
                i2 = 0;
                TXCLog.e(a, "CodecException1: " + e3 + ". step: " + i2);
                i++;
