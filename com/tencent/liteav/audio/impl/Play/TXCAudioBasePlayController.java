...
public class TXCAudioBasePlayController implements d {
    ...
    protected int mIsSmoothMode = b.g;
    ...
    protected native void nativeEnableSmoothMode(long j, int i);
    ...
    public void enableSmootheMode(int i) {
        if (i != this.mIsSmoothMode) {
            TXCLog.i(TAG, "set careful mode to " + i);
            this.mIsSmoothMode = i;
            nativeEnableSmoothMode(this.mJitterBuffer, i);
        }
    }
