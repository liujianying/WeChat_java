...
public class TXCStreamDownloader extends a implements com.tencent.liteav.basic.c.a, TXIStreamDownloader.a, e {
    ...
    private Runnable mReportNetStatusRunnalbe = new 3(this);
    ...
    public int start(String str, boolean z, int i, boolean z2) {
        boolean z3 = true;
        ...
        if (str.startsWith("room")) {
            ...
            int a = this.mAccUrlFetcher.a(str, i, new 2(this, z2, str));
            if (a != 0) {
                if (a == -1) {
