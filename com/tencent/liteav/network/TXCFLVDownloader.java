...
public class TXCFLVDownloader extends TXIStreamDownloader {
    ...
    public TXCFLVDownloader(Context context) {
        ...
        this.MSG_RECV_DATA = s$l.AppCompatTheme_buttonStyleSmall;
        this.MSG_DISCONNECT = s$l.AppCompatTheme_checkboxStyle;
        this.MSG_RECONNECT = s$l.AppCompatTheme_checkedTextViewStyle;
        this.MSG_SEEK = 104;
        this.MSG_RESUME = s$l.AppCompatTheme_radioButtonStyle;
        this.MSG_QUIT = s$l.AppCompatTheme_ratingBarStyle;
    ...
    private void processMsgConnect() {
        try {
            ...
            if (this.mFlvHandler != null) {
                this.mFlvHandler.sendEmptyMessage(s$l.AppCompatTheme_buttonStyleSmall);
            }
    ...
    private void postReconnectMsg() {
        if (this.mFlvHandler != null) {
            this.mFlvHandler.sendEmptyMessageDelayed(s$l.AppCompatTheme_checkedTextViewStyle, (long) (this.connectRetryInterval * 1000));
        }
    }

    private void postDisconnectMsg() {
        if (this.mFlvHandler != null) {
            this.mFlvHandler.sendEmptyMessage(s$l.AppCompatTheme_checkboxStyle);
        }
    }
        ...
        if (this.mIsRunning) {
            ...
            try {
                if (this.mFlvHandler != null) {
                    ...
                    this.mFlvHandler.sendEmptyMessage(s$l.AppCompatTheme_checkboxStyle);
                    this.mFlvHandler.sendEmptyMessage(s$l.AppCompatTheme_ratingBarStyle);
                    this.mFlvHandler = null;
                }
            } catch (Exception e) {
            }
