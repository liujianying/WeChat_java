...
public class d {
    ...
    public d(Context context) {
        ...
        this.o = Downloads.MIN_RETYR_AFTER;
        this.u = 0;
    }
    ...
    public void e() {
        ...
        if (this.m && TXCTimeUtil.getTimeTick() > this.n + ((long) this.o)) {
            if (this.p) {
                ...
                if (this.o < Downloads.MIN_RETYR_AFTER) {
                    this.o = Downloads.MIN_RETYR_AFTER;
                }
                if (this.o > 300000) {
                    this.o = 300000;
    ...
    private void h() {
        ...
        TXCDRApi.txSetEventIntValue(str, a.V, "u32_speed_cnt", TXCStatus.b(this.v, 2004));
        TXCDRApi.txSetEventIntValue(str, a.V, "u32_nodata_cnt", TXCStatus.b(this.v, 2005));
        TXCDRApi.txSetEventIntValue(str, a.V, "u32_avg_cache_time", TXCStatus.b(this.v, 2007));
        TXCDRApi.txSetEventIntValue(str, a.V, "u32_is_real_time", TXCStatus.b(this.v, 2008));
    ...
    private void i() {
        ...
        TXCDRApi.txSetEventIntValue(str, a.U, "u32_avg_net_speed", (long) (TXCStatus.d(this.v, 7102) + TXCStatus.d(this.v, 7101)));
        TXCDRApi.txSetEventIntValue(str, a.U, "u32_fps", (long) ((int) TXCStatus.e(this.v, 6002)));
    ...
    private void n() {
        ...
        String c4 = TXCStatus.c(this.v, 3001);
        String str = (String) this.b.get("token");
        ...
        TXCDRApi.txSetEventValue(str, a.Q, "str_beauty_stats", c4);
    ...
    private void p() {
        ...
        long b5 = TXCStatus.b(this.v, 2007);
    ...
    private void q() {
        ...
        this.l = b;
        TXCDRApi.txSetEventIntValue(str, a.X, "u32_video_cache_count", TXCStatus.b(this.v, 2006));
        int[] a = com.tencent.liteav.basic.util.a.a();
