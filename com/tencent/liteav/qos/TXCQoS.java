                ...
                if (access$700 == TXCQoS.this.mWidth && access$800 == TXCQoS.this.mHeight) {
                    if (onGetEncoderRealBitrate != TXCQoS.this.mBitrate) {
                        ...
                        if (TXCQoS.this.mNotifyListener != null) {
                            bundle = new Bundle();
                            bundle.putCharSequence("EVT_MSG", "调整编码码率:new bitrate:" + onGetEncoderRealBitrate);
                    ...
                    if (TXCQoS.this.mNotifyListener != null) {
                        bundle = new Bundle();
                        bundle.putCharSequence("EVT_MSG", "调整分辨率:new bitrate:" + onGetEncoderRealBitrate + " new resolution:" + access$700 + "*" + access$800);
                        bundle.putLong("EVT_TIME", TXCTimeUtil.getTimeTick());
