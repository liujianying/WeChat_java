...
public class HttpproxyFacade {
    ...
    public static void jsonReport(String str) {
        try {
            ...
            String str2 = "";
            WifiInfo connectionInfo = ((WifiManager) mContext.getSystemService(TencentExtraKeys.LOCATION_SOURCE_WIFI)).getConnectionInfo();
            ...
            if (!TextUtils.isEmpty(str2)) {
                ...
                if (str2.length() <= TbsLog.TBSLOG_CODE_SDK_BASE) {
                    instance.mUtils.httpproxyReport(new String[]{str2});
                    return;
                }
                ...
                String substring = str2.substring(0, TbsLog.TBSLOG_CODE_SDK_BASE);
                valueOf2 = str2.substring(TbsLog.TBSLOG_CODE_SDK_BASE, length);
                instance.mUtils.httpproxyReport(new String[]{substring, valueOf2});
            }
        } catch (Throwable th) {
    ...
    public static void kvReport(String str) {
        try {
            ...
            HttpproxyFacade instance = instance();
            if (instance.mUtils != null) {
                instance.mUtils.kvReport(new String[]{optString, optString2, httpProxyVersionCode, configVersion, optString3, optString4, optString5, optString6, optString7, optString8, optString9, optString10});
            }
        } catch (Throwable th) {
