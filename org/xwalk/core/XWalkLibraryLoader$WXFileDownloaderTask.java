...
class XWalkLibraryLoader$WXFileDownloaderTask extends AsyncTask<Void, Integer, Integer> implements c {
    ...
    XWalkLibraryLoader$WXFileDownloaderTask(DownloadListener downloadListener, Context context, XWalkUpdater$UpdateConfig xWalkUpdater$UpdateConfig) {
        this.mListener = downloadListener;
        this.mContext = context;
        this.mDownloadConfig = xWalkUpdater$UpdateConfig;
        this.mWXFileDownloaderBridge = new d();
        this.mWXFileDownloaderBridge.vAX = this;
    }
    ...
    protected Integer doInBackground(Void... voidArr) {
        ...
        if (d.vAW != null) {
            a = d.vAW.a(str, downloadPath, dVar);
        } else {
            a = -1;
        }
        if (a != 0) {
        ...
        synchronized (this.lockObj) {
            try {
                ...
                this.mErrorType = 2;
                this.mErrorCode = ERROR_CODE_EXCEPTION;
            }
            Integer valueOf;
    ...
    protected void onPostExecute(Integer num) {
        ...
        e.bh(15124, i + "," + availableVersion + "," + i3 + ",21," + this.mErrorCode + "," + this.mNetWorkType + "," + this.mRetryTimes + "," + currentTimeMillis + "," + this.mFileTotalSize + ",2," + i2);
    }
