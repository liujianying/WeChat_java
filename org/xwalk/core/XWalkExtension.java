...
public abstract class XWalkExtension {
    ...
    public void postMessage(int i, String str) {
        try {
            this.postMessageintStringMethod.invoke(new Object[]{Integer.valueOf(i), str});
    ...
    public void postBinaryMessage(int i, byte[] bArr) {
        try {
            this.postBinaryMessageintbyteArrayMethod.invoke(new Object[]{Integer.valueOf(i), bArr});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
    ...
    public void broadcastMessage(String str) {
        try {
            this.broadcastMessageStringMethod.invoke(new Object[]{str});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
    ...
    public void onInstanceCreated(int i) {
        try {
            this.onInstanceCreatedintMethod.invoke(new Object[]{Integer.valueOf(i)});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
    ...
    public void onInstanceDestroyed(int i) {
        try {
            this.onInstanceDestroyedintMethod.invoke(new Object[]{Integer.valueOf(i)});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
    ...
    public void onBinaryMessage(int i, byte[] bArr) {
        try {
            this.onBinaryMessageintbyteArrayMethod.invoke(new Object[]{Integer.valueOf(i), bArr});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
    ...
    void reflectionInit() {
        ...
        try {
            ...
            this.postBinaryMessageintbyteArrayMethod.init(this.bridge, null, "postBinaryMessageSuper", new Class[]{Integer.TYPE, byte[].class});
            ...
            this.onBinaryMessageintbyteArrayMethod.init(this.bridge, null, "onBinaryMessageSuper", new Class[]{Integer.TYPE, byte[].class});
