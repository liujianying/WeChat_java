...
public class XWalkEnvironment {
    ...
    public static SharedPreferences getProcessSafePreferences(String str, int i) {
        ...
        try {
            Object invoke = sSafePSProvider.invoke(null, new Object[]{sApplicationContext, str, Integer.valueOf(i)});
