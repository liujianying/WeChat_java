...
public class XWalkCoreWrapper {
    ...
    public boolean checkCoreVersion() {
        ...
        try {
            ...
            if (XWalkEnvironment.isDownloadMode() && XWalkEnvironment.isDownloadModeUpdate() && !str.isEmpty() && !str.equals("24.53.595.0")) {
                this.mCoreStatus = 8;
                return false;
    ...
    private boolean checkCoreArchitecture() {
        try {
            ...
            if (this.mBridgeContext != null) {
                ...
                booleanValue = ((Boolean) reflectMethod.invoke(new Object[]{this.mWrapperContext, str})).booleanValue();
            } else {
                booleanValue = false;
            }
            if (booleanValue) {
