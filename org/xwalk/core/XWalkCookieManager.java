...
public class XWalkCookieManager {
    ...
    public void setAcceptCookie(boolean z) {
        try {
            this.setAcceptCookiebooleanMethod.invoke(new Object[]{Boolean.valueOf(z)});
    ...
    public void setCookie(String str, String str2) {
        try {
            this.setCookieStringStringMethod.invoke(new Object[]{str, str2});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
    ...
    public String getCookie(String str) {
        try {
            return (String) this.getCookieStringMethod.invoke(new Object[]{str});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
    ...
    public void setAcceptFileSchemeCookies(boolean z) {
        try {
            this.setAcceptFileSchemeCookiesbooleanMethod.invoke(new Object[]{Boolean.valueOf(z)});
        } catch (RuntimeException e) {
            if (this.coreWrapper == null) {
                throw new RuntimeException("Crosswalk's APIs are not ready yet");
            }
