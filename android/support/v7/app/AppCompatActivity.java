...
public class AppCompatActivity extends FragmentActivity implements a, d {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (delegate.df() && this.mThemeId != 0) {
    ...
    public void onCreateSupportNavigateUpTaskStack(an anVar) {
        ...
        if (b != null) {
            ...
            if (component == null) {
                component = b.resolveActivity(anVar.qO.getPackageManager());
            }
            anVar.a(component);
            anVar.qN.add(b);
        }
    ...
    public boolean onSupportNavigateUp() {
        ...
        if (supportShouldUpRecreateTask(supportParentActivityIntent)) {
            ...
            Intent[] intentArr = (Intent[]) N.qN.toArray(new Intent[N.qN.size()]);
            intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
            Context context = N.qO;
