...
public final class w {
    public static final Rect Or = new Rect();
    private static Class<?> Os;

    static {
        if (VERSION.SDK_INT >= 18) {
            try {
                Os = Class.forName("android.graphics.Insets");
            } catch (ClassNotFoundException e) {
            }
        }
    }

    public static Rect l(Drawable drawable) {
        if (Os != null) {
            try {
                    ...
                    if (drawable2 instanceof GradientDrawable) {
                        ...
                        if (drawable2 instanceof DrawableContainer) {
                            ...
                            if (constantState instanceof DrawableContainerState) {
                                for (Drawable n : ((DrawableContainerState) constantState).getChildren()) {
                                    if (!n(n)) {
                                        return false;
                                    }
                                }
