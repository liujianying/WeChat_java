...
final class ah {
    static int a(q qVar, ab abVar, View view, View view2, h hVar, boolean z, boolean z2) {
        ...
        return Math.round((((float) max) * (((float) Math.abs(abVar.aV(view2) - abVar.aU(view))) / ((float) (Math.abs(h.bd(view) - h.bd(view2)) + 1)))) + ((float) (abVar.fs() - abVar.aU(view))));
    }
    ...
    static int a(q qVar, ab abVar, View view, View view2, h hVar, boolean z) {
        ...
        return Math.min(abVar.fu(), abVar.aV(view2) - abVar.aU(view));
    }
