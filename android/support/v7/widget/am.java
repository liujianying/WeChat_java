...
public final class am extends ContextWrapper {
    ...
    public static Context T(Context context) {
        Object obj = ((context instanceof am) || (context.getResources() instanceof ao) || (context.getResources() instanceof ar)) ? null : (!e.dg() || VERSION.SDK_INT <= 20) ? 1 : null;
        if (obj == null) {
            return context;
        }
        Context context2;
        ...
        for (int i = 0; i < size; i++) {
            WeakReference weakReference = (WeakReference) Wr.get(i);
        ...
        Wr.add(new WeakReference(context2));
        return context2;
    }
