...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.No = obtainStyledAttributes.getBoolean(k.ButtonBarLayout_allowStacking, false);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (eM() || MeasureSpec.getMode(i) != 1073741824) {
            i3 = i;
            z = false;
        } else {
        ...
        if (this.No && !eM()) {
            ...
            } else if ((z.L(this) & -16777216) == 16777216) {
                z2 = true;
            }
            if (z2) {
                setStacked(true);
