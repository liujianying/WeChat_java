...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public void setInitialSavedState(SavedState savedState) {
        ...
        Bundle bundle = (savedState == null || savedState.ny == null) ? null : savedState.ny;
    ...
    public t getLoaderManager() {
        ...
        this.mLoaderManager = this.mHost.b(this.mWho, this.mLoadersStarted, true);
        return this.mLoaderManager;
    }
    ...
    public void onStart() {
        ...
        if (!this.mLoadersStarted) {
            ...
            if (!this.mCheckedForLoaderManager) {
                this.mCheckedForLoaderManager = true;
                this.mLoaderManager = this.mHost.b(this.mWho, this.mLoadersStarted, false);
            }
            if (this.mLoaderManager != null) {
    ...
    void performCreate(Bundle bundle) {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.nX = false;
        }
        this.mState = 1;
        this.mCalled = false;
        onCreate(bundle);
