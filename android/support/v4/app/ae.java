...
final class ae {
    ...
    public static void a(y yVar, CharSequence charSequence, boolean z, CharSequence charSequence2, CharSequence charSequence3) {
        BigTextStyle bigText = new BigTextStyle(yVar.bx()).setBigContentTitle(charSequence).bigText(charSequence3);
        if (z) {
    ...
    public static void a(y yVar, CharSequence charSequence, boolean z, CharSequence charSequence2, Bitmap bitmap, Bitmap bitmap2, boolean z2) {
        BigPictureStyle bigPicture = new BigPictureStyle(yVar.bx()).setBigContentTitle(charSequence).bigPicture(bitmap);
        if (z2) {
    ...
    public static void a(y yVar, CharSequence charSequence, boolean z, CharSequence charSequence2, ArrayList<CharSequence> arrayList) {
        InboxStyle bigContentTitle = new InboxStyle(yVar.bx()).setBigContentTitle(charSequence);
        if (z) {
    ...
    public static Bundle a(Notification notification) {
        synchronized (qh) {
            ...
            try {
                ...
                Bundle bundle = (Bundle) qi.get(notification);
                if (bundle == null) {
                    bundle = new Bundle();
                    qi.set(notification, bundle);
                }
                return bundle;
    ...
    public static Bundle b(Builder builder, a aVar) {
        ...
        if (aVar.bz() != null) {
            bundle.putParcelableArray("android.support.remoteInputs", ak.b(aVar.bz()));
        }
        return bundle;
    }
}
