...
public final class a extends android.support.v4.content.a {
    ...
    private static class b extends android.support.v4.app.b.a {
        ...
        public final Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
            ...
            float min = Math.min(1.0f, ((float) al.qL) / ((float) (round * round2)));
            ...
            alVar.qK.set(matrix);
            alVar.qK.postTranslate(-rectF.left, -rectF.top);
            alVar.qK.postScale(min, min);
            Parcelable createBitmap = Bitmap.createBitmap(round, round2, Config.ARGB_8888);
            Canvas canvas = new Canvas(createBitmap);
            canvas.concat(alVar.qK);
            view.draw(canvas);
            return createBitmap;
        }
