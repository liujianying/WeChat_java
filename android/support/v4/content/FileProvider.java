...
public class FileProvider extends ContentProvider {
    private static final String[] qP = new String[]{"_display_name", "_size"};
    private static final File qQ = new File("/");
    private static HashMap<String, a> qR = new HashMap();
    private a qS;
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if (providerInfo.exported) {
            ...
            this.qS = g(context, providerInfo.authority);
        } else {
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return this.qS.b(uri).delete() ? 1 : 0;
    }
    ...
    private static android.support.v4.content.FileProvider.a g(android.content.Context r10, java.lang.String r11) {
        /*
        r2 = 0;
        r9 = 1;
        r3 = qR;
        monitor-enter(r3);
        r0 = qR;	 Catch:{ all -> 0x003e }
    ...
    L_0x0041:
        ...
        r6 = r0.qU;	 Catch:{ IOException -> 0x0034, XmlPullParserException -> 0x008d }
    ...
    L_0x0070:
        r1 = qQ;	 Catch:{ IOException -> 0x0034, XmlPullParserException -> 0x008d }
        r7 = 1;
    ...
    L_0x00fd:
        ...
        goto L_0x007c;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.content.FileProvider.g(android.content.Context, java.lang.String):android.support.v4.content.FileProvider$a");
    }
