...
public final class w {
    ...
    public w(String str) {
        this.c = str;
        cd.a(str, "");
        ac.a().a(new x(this), true, (long) this.b);
    }
    ...
    private synchronized void c() {
        try {
            ...
            cd.a(this.c, stringBuilder.toString());
        } catch (Throwable th) {
            cd.a(this.c, "");
        }
        return;
    ...
    final synchronized void a() {
        synchronized (this) {
            try {
                this.e.clear();
                this.f.clear();
                Object b = cd.b(this.c, "");
                if (!TextUtils.isEmpty(b)) {
                    int a = a("black_list_outofdate", 60000, 86400000, 7200000);
    ...
    public static int a(String str, int i, int i2, int i3) {
        ...
        return ci.a(parseInt, i, i2, i3);
    }

    private static String a(String str, int i) {
        return ((bx) bz.c().a.get("settings")).a(str, i, m.e(), m.a, bf.a().a(p.b()), cd.a(p.g()));
    }
    ...
    public static boolean a(String str, boolean z, Map<String, String> map) {
        ...
        try {
            au f = au.f();
            String a = au.a(str, z, map);
            try {
                if (f.b.getAndIncrement() > f.c) {
                    f.b.decrementAndGet();
                } else {
                    new al$b(f, a).a(false);
                }
            } catch (Throwable th) {
            }
        } catch (Throwable th2) {
    ...
    public static byte[] a(byte[] bArr) {
        ...
        deflater.finish();
        byte[] bArr2 = new byte[ab.CTRL_BYTE];
