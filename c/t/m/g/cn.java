...
public class cn implements Observer {
    ...
    public void update(Observable observable, Object obj) {
        ...
        if (str != null && str.length() != 0) {
            String str2 = "update [" + str + "] : " + ((String) this.h.get(str)) + " --> ";
            f(str);
            cj.a("CC_Set", str2 + ((String) this.h.get(str)));
        ...
        try {
            ...
            if (b != null) {
                ...
                if (c.length() > 0 && !c.equals(string)) {
                    cj.a("CC_Set", "clear sp > pre:" + string + ",now:" + c);
                    b.edit().clear().apply();
