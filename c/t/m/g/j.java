...
public final class j implements f {
    ...
    public static boolean a(Object obj) {
        return (obj == null || ((WeakReference) obj).get() == null) ? false : true;
    }
    ...
    public static int c(Context context) {
        try {
            ...
            try {
                ...
                for (File file : new File(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separatorChar + "Android" + File.separatorChar + "data").listFiles()) {
