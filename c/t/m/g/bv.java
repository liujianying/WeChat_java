...
final class bv implements Runnable {
    ...
    public final void run() {
        ...
        r1 = new c.t.m.g.bh;	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
        r1.<init>();	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
        r0 = r10.a;	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
        r0 = c.t.m.g.bp.c(r0);	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
    ...
    L_0x001e:
        ...
        r0 = (c.t.m.g.bl) r0;	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
    ...
    L_0x004b:
        ...
        r0 = c.t.m.g.ci.a(r2);	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
        if (r0 != 0) goto L_0x010f;
    L_0x0055:
        r0 = "https://yun-hl.3g.qq.com/halleycloud";
        r1 = 0;
        r3 = 15000; // 0x3a98 float:2.102E-41 double:7.411E-320;
        r4 = c.t.m.g.ci.d();	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
        r5 = c.t.m.g.bz.c();	 Catch:{ Throwable -> 0x0028, all -> 0x00e5 }
    ...
    L_0x0080:
        ...
        r3 = c.t.m.g.ci.a(r3);	 Catch:{ Throwable -> 0x010b, all -> 0x0108 }
        if (r3 != 0) goto L_0x00b6;
    L_0x0088:
        ...
        r0 = c.t.m.g.bp.c(r0);	 Catch:{ Throwable -> 0x00b5, all -> 0x0108 }
    ...
    L_0x00ab:
        ...
        r0 = (c.t.m.g.bl) r0;	 Catch:{ Throwable -> 0x00b5, all -> 0x0108 }
    ...
    L_0x010f:
        ...
        goto L_0x00c2;
        */
        throw new UnsupportedOperationException("Method not decompiled: c.t.m.g.bv.run():void");
    }
}
