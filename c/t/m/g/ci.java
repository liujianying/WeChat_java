...
public final class ci {
    ...
    public static String a(Context context, int i) {
        ...
        String str2;
        List runningAppProcesses2 = activityManager.getRunningAppProcesses();
        if (runningAppProcesses2 != null && runningAppProcesses2.size() > 0) {
            int size2 = runningAppProcesses2.size();
            for (int i22 = 0; i22 < size2; i22++) {
                RunningAppProcessInfo runningAppProcessInfo2 = (RunningAppProcessInfo) runningAppProcesses2.get(i22);
                if (runningAppProcessInfo2 != null && runningAppProcessInfo2.pid == i) {
    ...
    private static String a(InetAddress inetAddress) {
        try {
            ...
            while (true) {
                ...
                stringBuilder.append("." + (address[i2] < (byte) 0 ? address[i2] + 256 : address[i2]));
                i = i2 + 1;
            }
        } catch (Throwable th) {
            return "";
    ...
    public static String d() {
        ...
        return ch.a(stringBuilder.toString());
    }
