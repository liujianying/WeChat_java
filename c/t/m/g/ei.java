...
public final class ei {
    ...
    public static byte[] a(String str, String str2) {
        try {
            Object a = ee.a(a(str.getBytes("GBK")), str2);
    ...
    public static String a(dq dqVar) {
        ...
        stringBuilder.append("\"" + a3 + "," + a4 + "," + a5 + "," + a6 + "," + dqVar.b + "\"");
        stringBuilder.append(",\"source\":");
        stringBuilder.append(dqVar.d - 1);
        stringBuilder.append("}");
    ...
    public static String a(dp dpVar, boolean z) {
        ...
        int i4 = dpVar.b;
        int i5 = dpVar.c;
        int ordinal = dpVar.a.ordinal();
        Iterable arrayList = new ArrayList();
        List<NeighboringCellInfo> a = dpVar.a();
        if (ec.a(ordinal, i4, i5, dpVar.d, dpVar.e)) {
            i = dpVar.d;
            i2 = dpVar.e;
            i3 = dpVar.f;
            int i6 = dpVar.g;
            ...
            a("illeagal main cell! ", i4, i5, ordinal, dpVar.d, dpVar.e);
        }
        try {
            for (NeighboringCellInfo neighboringCellInfo : a) {
                i2 = neighboringCellInfo.getLac();
                i3 = neighboringCellInfo.getCid();
                if (ec.a(ordinal, i4, i5, i2, i3)) {
                    i = (neighboringCellInfo.getRssi() << 1) - 113;
                    ...
                    a("illeagal neighboringCell! ", i4, i5, ordinal, i2, i3);
                }
            }
        } catch (Exception e) {
        }
        StringBuilder stringBuilder3 = new StringBuilder("[");
        stringBuilder3.append(new ef(",").a(new StringBuilder(), arrayList.iterator()).toString());
    ...
    public static String a(dt dtVar) {
        if (dtVar == null || Collections.unmodifiableList(dtVar.b) == null) {
            return "[]";
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[");
        if (Collections.unmodifiableList(dtVar.b) == null || Collections.unmodifiableList(dtVar.b).size() <= 0) {
            stringBuilder.append("]");
            return stringBuilder.toString();
        }
        int i = 0;
        List unmodifiableList = Collections.unmodifiableList(dtVar.b);
