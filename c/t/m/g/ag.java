...
public final class ag extends ae {
    ...
    public static ag a(String str, Map<String, String> map, byte[] bArr, int i, String str2, s sVar) {
        return new ag(str, map, bArr, i, str2, false, sVar, "");
    }
    ...
    public final void a(boolean z) {
        if (this.q != null) {
            ...
            hashMap2.put("B44", ci.b(this.a));
            if (!(TextUtils.isEmpty(this.a) || this.a.equals(this.x))) {
                hashMap2.put("B49", ci.b(this.x));
            }
            if (this.v != null) {
                if (!this.v.b()) {
            ...
            if (akVar.A) {
                ce.a("HLHttpDirect", m.b(), i, akVar.o.b, hashMap3, hashMap4, akVar.i);
            } else {
                ce.b("HLHttpDirect", m.b(), i, akVar.o.b, hashMap3, hashMap4, akVar.i);
            }
        }
    }
        ...
        try {
            ...
            while (i2 < size) {
                ...
                if (obj == null && this.r.a == -4) {
                    int a2 = w.a("direct_nonet_retry_gap", 0, 10000, 3000);
                    long j = this.q.w;
                    if (j >= ((long) a2)) {
                        obj = 1;
                    } else {
                        SystemClock.sleep((long) ci.a((int) (((long) a2) - j), 200, a2, 200));
                    }
                }
                if (obj != null) {
                    break;
