...
public final class ej {
    ...
    public static boolean a(ct ctVar) {
        try {
            WifiManager wifiManager = ctVar.f;
    ...
    public static boolean b(ct ctVar) {
        ...
        try {
            if (VERSION.SDK_INT >= 23 && Secure.getInt(ctVar.a.getContentResolver(), "location_mode") == 0) {
                return false;
            }
            boolean isWifiEnabled = wifiManager.isWifiEnabled();
            if (isWifiEnabled || VERSION.SDK_INT < 18) {
