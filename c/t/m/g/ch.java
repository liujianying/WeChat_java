...
public final class ch {
    ...
    public static String a(String str) {
        ...
        ch chVar = new ch();
        chVar.a();
        chVar.a(new ByteArrayInputStream(bytes), (long) bytes.length);
        byte[] bArr = new byte[8];
        a(bArr, chVar.c, 8);
        int i = ((int) (chVar.c[0] >>> 3)) & 63;
        if (i < 56) {
            i = 56 - i;
        } else {
            i = 120 - i;
    ...
    private void a(byte[] bArr) {
        ...
        while (true) {
            ...
            if (i3 < 64) {
                ...
                j5 = a(j, j2, j3, j4, jArr[0], 7, 3614090360L);
                j4 = a(j4, j5, j2, j3, jArr[1], 12, 3905402710L);
                j3 = a(j3, j4, j5, j2, jArr[2], 17, 606105819);
                j6 = a(j2, j3, j4, j5, jArr[3], 22, 3250441966L);
                j5 = a(j5, j6, j3, j4, jArr[4], 7, 4118548399L);
                j4 = a(j4, j5, j6, j3, jArr[5], 12, 1200080426);
                long a = a(j3, j4, j5, j6, jArr[6], 17, 2821735955L);
                j6 = a(j6, a, j4, j5, jArr[7], 22, 4249261313L);
                j5 = a(j5, j6, a, j4, jArr[8], 7, 1770035416);
                long a2 = a(j4, j5, j6, a, jArr[9], 12, 2336552879L);
                a = a(a, a2, j5, j6, jArr[10], 17, 4294925233L);
                j6 = a(j6, a, a2, j5, jArr[11], 22, 2304563134L);
                long a3 = a(j5, j6, a, a2, jArr[12], 7, 1804603682);
                a2 = a(a2, a3, j6, a, jArr[13], 12, 4254626195L);
                a = a(a, a2, a3, j6, jArr[14], 17, 2792965006L);
                long a4 = a(j6, a, a2, a3, jArr[15], 22, 1236535329);
                ...
                j = d(d2, d3, d4, d5, jArr[9], 21, 3951481745L);
                long[] jArr2 = this.b;
                jArr2[0] = jArr2[0] + d5;
                jArr2 = this.b;
                jArr2[1] = j + jArr2[1];
